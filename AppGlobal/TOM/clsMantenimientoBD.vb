...
Public Class clsMantenimientoBD
    ...
    'Public Shared Sub Ejecutar_Backup_BD()
    ...
    '        ' Reemplaza "TuServidor" y "TuBaseDeDatos" con la información correspondiente
    '        Dim serverName As String = "TuServidor"
    '        Dim databaseName As String = "TuBaseDeDatos"

    '        ' Reemplaza "Ruta\Donde\Guardar\Backup" con la ruta donde deseas guardar el archivo .bak
    '        Dim backupPath As String = "Ruta\Donde\Guardar\Backup"

    '        ' Nombre del archivo de backup
    '        Dim backupFileName As String = $"{databaseName}_Backup_{DateTime.Now.ToString("yyyyMMdd_HHmmss")}.bak"

    '        ' Query para realizar el backup
    '        Dim backupQuery As String = $"BACKUP DATABASE [{databaseName}] TO DISK = '{backupPath}\{backupFileName}'"
    ...
    '                Console.WriteLine($"Backup exitoso. Ruta del archivo: {backupPath}\{backupFileName}")
    '            Catch ex As Exception
