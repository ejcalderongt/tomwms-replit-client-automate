Public Class clsStockEx

    Public Shared Property ErrorS0001 As String =
        "No se pudo obtener el registro de stock asociado a la transacción #ERR_S0001"

    Public Shared Property ErrorS0002 As String =
        "La cantidad solicitada es mayor que la existencia disponible "

    Public Shared Property ErrorS0003 As String =
    ...
    Public Shared Property ErrorS0005 As String =
       "ErrorS0005 - No se pudo reservar el stock, la lista no tiene registros"

    Public Shared Property ErrorS0006 As String =
       "ErrorS0006  - No se pudo insertar el stock en la tabla de reserva stock_res"
