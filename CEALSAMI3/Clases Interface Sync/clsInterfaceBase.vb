...
Public MustInherit Class clsInterfaceBase
    ...
    Public Function Ejecutar_Interfaz(ByVal NombreEntidad As String) As Boolean
        ...
        Try
            ...
            ListaDetalleConfigDet = clsLnI_nav_config_det.Get_All_By_IdEnc(IIf(BD.Instancia.IdConfiguracionInterface = -1, 1, BD.Instancia.IdConfiguracionInterface), NombreEntidad)
