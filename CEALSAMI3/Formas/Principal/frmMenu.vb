...
Public Class frmMenu
    ...
    Private Sub Set_Info_Conexion()
        ...
        Try
            ...
            lblServidorERP.Caption = BD.Instancia.SERVER_ERP & " - " & BD.Instancia.NOMBRE_BD_ERP

            If Interface_A_Ejecutar <> -1 Then
                lblInterface.Caption = "Configuración Interface: " & Interface_A_Ejecutar
            Else
                lblInterface.Caption = ""
            End If

            '#EJC20210305: Aquí no aplica
