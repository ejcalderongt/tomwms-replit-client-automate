...
Public Class clsSyncNavPedidoTraslado1 : Inherits clsInterfaceBase
                                ...
                                Try
                                    ...
                                    If Not L.Item_No Is Nothing Then
                                        ...
                                        If Not BeProductoBodega Is Nothing Then
                                            ...
                                            If (L.Qty_to_Ship = 0) AndAlso (L.Quantity_Shipped > 0) AndAlso (L.Quantity_Received < L.Quantity_Shipped) Then
                                                ...
                                                If lLotes.Count > 1 Then
                                                    ...
                                                    For Each Lote In listLotes
                                                        ...
                                                        For Each NavLote In lLotes.OrderBy(Function(x) x.Lot_No).ToList
                                                            vLote = NavLote
                                                            If NavLote.Lot_No = Lote Then
                                            ...
                                            Else
                                                lblprg.AppendText(String.Format("La cantidad para el producto:{0} ya fue completada.{1}", L.Item_No, vbNewLine))
                                                lblprg.AppendText(vbNewLine)
                                                lblprg.Refresh()
                                                lblprg.SelectionStart = lblprg.TextLength
                                                lblprg.ScrollToCaret()
    ...
    Public Function Importar_Pedidos_Transferencia_Recepcion_Desde_Tabla_Intermedia_A_Tabla_TOMIMS(ByRef lblprg As RichTextBox,
        ...
        Try
            ...
            lblprg.AppendText("Consultando WebService de bodega en: " & My.MySettings.Default.DynamicsNavInterface_WsPedidoTransferencia_Pedidos_Transferencia_Service)
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
            ...
            If lPedidoCompraEnc.Count > 0 Then
                ...
                For Each navPedidoTransferRec As clsBeI_nav_ped_compra_enc In lPedidoCompraEnc
                    ...
                    If navPedidoTransferRec.Status <> 0 Then
                        ...
                        If navPedidoTransferRec.No = "PT-184094" Then
                            Debug.Print("ESPERA")
                        End If

                        lblprg.AppendText(String.Format("Procesando O.C.: {0} ", navPedidoTransferRec.No, vbNewLine))
                        lblprg.AppendText(vbNewLine)
                        lblprg.SelectionStart = lblprg.TextLength
                        lblprg.ScrollToCaret()
                        ...
                        If Not PedidoCompraExistente Is Nothing Then
                            ...
                            lblprg.AppendText(String.Format("Procesando# : {0}{1}", navPedidoTransferRec.No, vbNewLine))
                            lblprg.AppendText(vbNewLine)
                            lblprg.Refresh()
                            lblprg.SelectionStart = lblprg.TextLength
                            lblprg.ScrollToCaret()
...
#End Region
                                                ...
                                                Try
                                                    ...
                                                    Else
                                                        ...
                                                        Select Case DifCant
                                                            ...
                                                            Case 0
                                                                lblprg.AppendText(String.Format("La cantidad no se modificó para pedido {0} producto {1} {2}", navPedidoTransferRec.No, navPedidoCompraDet.No, vbNewLine))
                                                            Case Is > 0
                                                                lblprg.AppendText(String.Format("La cantidad incrementó respecto a TOM para pedido {0} producto {1} {2} ", navPedidoTransferRec.No, navPedidoCompraDet.No, vbNewLine))
                                                            Case Is < 0
                                                                lblprg.AppendText(String.Format("La cantidad disminuyó respecto al original en WMS  para pedido {0} producto {1} {2} ", navPedidoTransferRec.No, navPedidoCompraDet.No, vbNewLine))
                                                            Case Else
                                                                Exit Select
                                                        End Select
                                                    ...
                                                    If Not PedidoCompraExistente.DetalleLotes Is Nothing Then
                                                        ...
                                                        If PedidoCompraExistente.DetalleLotes.Count > 0 Then
                                                            ...
                                                            '#CKFK20230302 Así está en este momento y no se actualiza la cantidad
                        ...
                        Else
                            ...
                            If navPedidoTransferRec.Lineas_Detalle.Count = 0 Then
                                lblprg.AppendText(String.Format("Pedido #:{0} Sin Detalle {1}", navPedidoTransferRec.No, vbNewLine))
                                lblprg.AppendText(vbNewLine)
                                lblprg.Refresh()
                                lblprg.SelectionStart = lblprg.TextLength
                                lblprg.ScrollToCaret()
                            Else
                                ...
                                If BeProveedorBodega Is Nothing Then
                                    ...
                                    If BeProveedorBodega Is Nothing Then
                                        ...
                                        lblprg.AppendText(vbNewLine)
                                        lblprg.AppendText(String.Format("Error al insertar el pedido de compra: {0} El proveedor: {1} no existe, ¿Ya se actualizó maestro de proveedores?", navPedidoTransferRec.Buy_From_Vendor_No, navPedidoTransferRec.No, vbNewLine))
                                        lblprg.AppendText(vbNewLine)
                                        lblprg.Refresh()
                                        lblprg.SelectionStart = lblprg.TextLength
                                        lblprg.ScrollToCaret()
                                    ...
                                    Else
                                        ...
                                        lblprg.AppendText(String.Format("El proveedor: {1} no existía pero se insertó para el pedido de compra: {0}. Nada de que preocuparse :) ", navPedidoTransferRec.Buy_From_Vendor_No, navPedidoTransferRec.No, vbNewLine))
                                        lblprg.AppendText(vbNewLine)
                                        lblprg.Refresh()
                                        lblprg.SelectionStart = lblprg.TextLength
                                        lblprg.ScrollToCaret()
...
#End Region
                                                        ...
                                                        Try
                                                            ...
                                                            Else
                                                                ...
                                                                Select Case DifCant
                                                                    ...
                                                                    Case 0
                                                                        lblprg.AppendText(String.Format("La cantidad no se modificó para pedido {0} producto {1} ", navPedidoTransferRec.No, navPedidoCompraDet.No))
                                                                    Case Is > 0
                                                                        lblprg.AppendText(String.Format("La cantidad incrementó respecto a TOM para pedido {0} producto {1} ", navPedidoTransferRec.No, navPedidoCompraDet.No))
                                                                    Case Is < 0
                                                                        lblprg.AppendText(String.Format("La cantidad disminuyó respecto al original en WMS  para pedido {0} producto {1} ", navPedidoTransferRec.No, navPedidoCompraDet.No))
                                                                    Case Else
                                                                        Exit Select
                                                                End Select
                                ...
                                Catch ex As Exception
                                    ...
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.AppendText(String.Format("Error al insertar Documento de Ingreso con Referencia: {0}{1}{2}", navPedidoTransferRec.No, vbNewLine, ex.Message))
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.Refresh()
                                    lblprg.SelectionStart = lblprg.TextLength
                                    lblprg.ScrollToCaret()
                    ...
                    Else
                        ...
                        lblprg.AppendText(String.Format("OC Inactiva {0} ", navPedidoTransferRec.No, vbNewLine))
                        lblprg.AppendText(vbNewLine)
                        lblprg.SelectionStart = lblprg.TextLength
                        lblprg.ScrollToCaret()
    ...
    Public Function Importar_Pedidos_Transferencia_Envio_Desde_Tabla_Intermedia_A_Tabla_TOMIMS(ByRef lblprg As RichTextBox,
        ...
        Try
            ...
            lblprg.AppendText("Consultando WebService de pedido de traslado en: " & My.MySettings.Default.DynamicsNavInterface_WsPedidoTransferencia_Pedidos_Transferencia_Service)
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
            ...
            lblprg.AppendText(vbNewLine)
            lblprg.AppendText("Consultando pedidos de traslado en tabla intermedia ")
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
            ...
            lblprg.AppendText(String.Format("Pedidos de traslado en tabla intermedia: {0}", lPedidoTrasladoEnc.Count))
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
            ...
            If lPedidoTrasladoEnc.Count > 0 Then
                ...
                For Each navPedidoTrasladoEnc As clsBeI_nav_ped_traslado_enc In lPedidoTrasladoEnc
                    ...
                    If navPedidoTrasladoEnc.Status > 0 Then
                        ...
                        lblprg.AppendText(String.Format("Procesando P.T.: {0} ", navPedidoTrasladoEnc.No, vbNewLine))
                        lblprg.AppendText(vbNewLine)
                        lblprg.SelectionStart = lblprg.TextLength
                        lblprg.ScrollToCaret()
    ...
    Public Sub Enviar_Transacciones_De_Salida(ByRef lblprg As RichTextBox,
        ...
        Try
            ...
            If Not lTransaccionesSalida Is Nothing AndAlso lTransaccionesSalida.Count > 0 Then
                ...
                lblprg.AppendText(vbNewLine)
                lblprg.AppendText("Transacciones de salida:")
                lblprg.AppendText(vbNewLine)
                lblprg.AppendText(String.Format(vbNewLine & "Registros: {0}", lTransaccionesSalida.Count))
                lblprg.AppendText(vbNewLine)
                lblprg.Refresh()
                lblprg.SelectionStart = lblprg.TextLength
                lblprg.ScrollToCaret()
                    ...
                    If Not Enviado_A_Erp Then
                        ...
                        If Not Bodega_Avanzada Then
                            ...
                            Try
                                ...
                                lblprg.AppendText(String.Format(vbNewLine & "Transacciones de salida enviadas correctamente: {0}", lTransaccionesSalida.Count))
                                lblprg.AppendText(vbNewLine)
                                lblprg.Refresh()
                                lblprg.SelectionStart = lblprg.TextLength
                                lblprg.ScrollToCaret()
                            ...
                            Catch ex As Exception
                                ...
                                lblprg.AppendText(String.Format("Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.No_pedido, ex.Message))
                                lblprg.AppendText(vbNewLine)
                                lblprg.Refresh()
                                lblprg.SelectionStart = lblprg.TextLength
                                lblprg.ScrollToCaret()
                        ...
                        Else
                            ...
                            Catch ex As Exception
                                ...
                                lblprg.AppendText(String.Format(vbNewLine & "Error al registrar el pedido:{0} en el ERP. Error: {1} dentro del proceso {2}", PT.No_pedido, ex.Message, procesoError))
                                lblprg.AppendText(vbNewLine)
                                lblprg.Refresh()
                                lblprg.SelectionStart = lblprg.TextLength
                                lblprg.ScrollToCaret()
                        ...
                        If Not Bodega_Avanzada Then
                            ...
                            Try
                                ...
                                If Not TransferNav Is Nothing Then
                                    ...
                                    If lTransaccionesSalidaReproceso.Count > 0 Then
                                        ...
                                        Try
                                            ...
                                            lblprg.AppendText(String.Format(vbNewLine & "Se registró el pedido:{0} correctamente en el ERP.", PT.No_pedido))
                                            lblprg.AppendText(vbNewLine)
                                            lblprg.Refresh()
                                            lblprg.SelectionStart = lblprg.TextLength
                                            lblprg.ScrollToCaret()
                                        ...
                                        Catch ex As Exception
                                            ...
                                            lblprg.AppendText(String.Format(vbNewLine & "Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.No_pedido, ex.Message))
                                            lblprg.AppendText(vbNewLine)
                                            lblprg.Refresh()
                                            lblprg.SelectionStart = lblprg.TextLength
                                            lblprg.ScrollToCaret()
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        lblprg.AppendText(String.Format(vbNewLine & "El pedido:{0} ya fue enviado al ERP (Verifique si se completó y marque los registros en WMS para no ser enviados nuevamente)", PT.No_pedido))
                                        lblprg.AppendText(vbNewLine)
                                        lblprg.Refresh()
                                        lblprg.SelectionStart = lblprg.TextLength
                                        lblprg.ScrollToCaret()
                            ...
                            Catch ex As Exception
                                ...
                                If ex.Message = "There is nothing to post." Then 'Pedido sin nada que registrar
                                    ...
                                    lblprg.AppendText(String.Format(vbNewLine & "Nada que registrar para pedido: {0} en NAV.", PT.No_pedido))
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.Refresh()
                                    lblprg.SelectionStart = lblprg.TextLength
                                    lblprg.ScrollToCaret()
                                ...
                                Else
                                    ...
                                    clsLnI_nav_ejecucion_det_error.Inserta_Log(String.Format("Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.No_pedido, ex.Message),
                                BeNavEjecucionEnc.IdEjecucionEnc,
                                BeConfigDet.Idnavconfigdet, PT.No_pedido, CnnLog)
            ...
            lblprg.AppendText(vbNewLine)
            lblprg.AppendText("Buscando documentos pendientes de registro.")
            lblprg.AppendText(vbNewLine)
            lblprg.AppendText(String.Format(vbNewLine & "Registros: {0}", lTransPtPendienteRegistroEnNav.Count))
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
            ...
            If lTransPtPendienteRegistroEnNav.Count > 0 Then
                ...
                For Each PT In lTransPtPendienteRegistroEnNav
                    ...
                    If PT.Estado = "Despachado" OrElse PT.Estado = "Verificado" Then
                        ...
                        lblprg.AppendText(vbNewLine)
                        lblprg.AppendText("Registrando documento: " & PT.Referencia)
                        lblprg.AppendText(vbNewLine)
                        lblprg.AppendText(String.Format(vbNewLine & "Bodega avanzada: {0}", IIf(Bodega_Avanzada, "Sí", "No")))
                        lblprg.AppendText(vbNewLine)
                        lblprg.Refresh()
                        lblprg.SelectionStart = lblprg.TextLength
                        lblprg.ScrollToCaret()
                        ...
                        If Not Bodega_Avanzada Then
                                ...
                                If PT.Referencia <> "" Then
                                    ...
                                    If Not TransferNav Is Nothing Then
                                        ...
                                        If lTransaccionesSalida.Count > 0 Then
                                            ...
                                            lblprg.AppendText(vbNewLine)
                                            lblprg.AppendText(String.Format("Se registró el pedido:{0} correctamente en el ERP.", PT.Referencia))
                                            lblprg.AppendText(vbNewLine)
                                            lblprg.Refresh()
                                            lblprg.SelectionStart = lblprg.TextLength
                                            lblprg.ScrollToCaret()
                            ...
                            Catch ex As Exception
                                ...
                                If ex.Message = "There is nothing to post." Then 'Pedido sin nada que registrar
                                    ...
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.AppendText(String.Format("Nada que registrar para pedido: {0} en NAV.", PT.Referencia))
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.Refresh()
                                    lblprg.SelectionStart = lblprg.TextLength
                                    lblprg.ScrollToCaret()
            ...
            lblprg.AppendText(String.Format(vbNewLine & "Fin del proceso: {0}", Now))
            lblprg.AppendText(vbNewLine)
            lblprg.Refresh()
            lblprg.SelectionStart = lblprg.TextLength
            lblprg.ScrollToCaret()
    ...
    Public Sub Enviar_Transacciones_De_Salida_Anterior(ByRef lblprg As RichTextBox,
        ...
        Try
            ...
            If Not lTransaccionesSalida Is Nothing AndAlso lTransaccionesSalida.Count > 0 Then
                ...
                lblprg.AppendText(String.Format("Transacciones a enviar: {0}", lTransaccionesSalida.Count))
                lblprg.AppendText(vbNewLine)
                lblprg.Refresh()
                lblprg.SelectionStart = lblprg.TextLength
                lblprg.ScrollToCaret()
                        ...
                        If Enviar_Lotes_Transf(PT.No_pedido, lTransaccionesSalida, lblprg, prg) Then
                            ...
                            If Enviar_Cantidades_Transf(PT.No_pedido, lTransaccionesSalida, lblprg, prg) Then
                                ...
                                Try
                                    ...
                                    lblprg.AppendText(String.Format("Transacciones de salida enviadas correctamente: {0}", lTransaccionesSalida.Count))
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.Refresh()
                                    lblprg.SelectionStart = lblprg.TextLength
                                    lblprg.ScrollToCaret()
                                ...
                                Catch ex As Exception
                                    ...
                                    clsLnI_nav_ejecucion_det_error.Inserta_Log(
                                    String.Format("Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.No_pedido, ex.Message),
                                    PT.No_pedido,
                                    BeNavEjecucionEnc.IdEjecucionEnc,
                                    BeConfigDet.Idnavconfigdet, CnnLog)
                    ...
                    Else
                            ...
                            If Not TransferNav Is Nothing Then
                                ...
                                If lTransaccionesSalidaReproceso.Count > 0 Then
                                    ...
                                    Else
                                        ...
                                        lblprg.AppendText(String.Format("Se registró el pedido:{0} correctamente en el ERP.", PT.No_pedido))
                                        lblprg.AppendText(vbNewLine)
                                        lblprg.Refresh()
                                        lblprg.SelectionStart = lblprg.TextLength
                                        lblprg.ScrollToCaret()
                        ...
                        Catch ex As Exception
                            ...
                            If ex.Message = "There is nothing to post." Then 'Pedido sin nada que registrar
                                ...
                                lblprg.AppendText(String.Format("Nada que registrar para pedido: {0} en NAV.", PT.No_pedido))
                                lblprg.AppendText(vbNewLine)
                                lblprg.Refresh()
                                lblprg.SelectionStart = lblprg.TextLength
                                lblprg.ScrollToCaret()
                        ...
                        If PT.Estado = "Despachado" Or PT.Estado = "Verificado" Then
                            ...
                            Catch ex As Exception
                                ...
                                Else
                                    ...
                                    lblprg.AppendText(String.Format("Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.Referencia, ex.Message))
                                    lblprg.AppendText(vbNewLine)
                                    lblprg.Refresh()
                                    lblprg.SelectionStart = lblprg.TextLength
                                    lblprg.ScrollToCaret()
                                    ...
                                    clsLnI_nav_ejecucion_det_error.Inserta_Log(
                                    String.Format("Error al registrar el pedido:{0} en el ERP. Error: {1}", PT.Referencia, ex.Message),
                                    BeNavEjecucionEnc.IdEjecucionEnc,
                                    BeConfigDet.Idnavconfigdet, PT.Referencia, CnnLog)
        ...
        Try
            ...
            If Not listaLotes Is Nothing Then
                ...
                For Each I In listaLotes
                    ...
                    lblprg.AppendText(String.Format(vbNewLine & "Procesando Lote de Pedido: {0} Línea:{1} ", I.No_pedido, I.No_linea))
                    lblprg.AppendText(vbNewLine)
                    lblprg.Refresh()
                    lblprg.SelectionStart = lblprg.TextLength
                    lblprg.ScrollToCaret()
    ...
    Private Function Enviar_Cantidades_Transf(ByVal NoPedidoTransf As String,
        ...
        Try
            ...
            For Each I In ListaResumen
                ...
                lblprg.AppendText(String.Format(vbNewLine & "Procesando Cantidad de Pedido: {0} Línea:{1} ", I.No_pedido, I.No_linea))
                lblprg.AppendText(vbNewLine)
                lblprg.Refresh()
                lblprg.SelectionStart = lblprg.TextLength
                lblprg.ScrollToCaret()
                ...
                Catch ex As Exception
                    ...
                    lblprg.AppendText(String.Format(vbNewLine & "Error al enviar cantidad de pedido de transf. a Nav desde WS: {0} {1}", ex.Message, vbNewLine))
                    lblprg.SelectionStart = lblprg.TextLength
                    lblprg.ScrollToCaret()
