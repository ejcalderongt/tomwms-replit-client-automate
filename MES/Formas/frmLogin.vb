...
Public Class frmLogin
    ...
    Private frmPrintEtiqueta As New frmImprimir_Etiqueta()
    ...
    Private Async Sub carga_impresion_directa()
        Try
            ...
            Using frm As New frmImprimir_Etiqueta()
    ...
    Private Sub carga_menu_impresion()
        ...
        Try
            ...
            Try
                '#GT20022025: carga el menu, pero se invoca el form de print_label
                frmMenu.Id_StandAlone = ListaInstancias(0).ID_STANDALONE
                frmMenu.pImpresoraDefault = ListaInstancias(0).IMPRESORA_DEFAULT.Trim
                frmMenu.ShowDialog()
                frmMenu.Dispose()
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    '**************************************************************
                    '#GT03032025: instalacion QUICKTAG sin bd, usa datos hardcodeados!
                    If ListaInstancias(0).ID_STANDALONE = 1 Then
                        If ListaInstancias(0).ID_EMPRESA_QUICKTAG = 1 Then
        ...
        Catch ex1 As SqlClient.SqlException
            ...
            If ex1.HResult = -2146233088 OrElse ex1.HResult = -2146232060 Then
                ...
                If Not ListaInstancias Is Nothing Then
                    If XtraMessageBox.Show("No se pudo abrir la conexión a la base de datos con los parámetros de conexión para la instancia: " & ListaInstancias(0).NombreInstancia & " ¿Abrir editor de conexión? ",
                                            Text,
                                            MessageBoxButtons.YesNo,
                        ...
                        If Not a.ShowDialog() = DialogResult.OK Then
                            Close()
                        End If
