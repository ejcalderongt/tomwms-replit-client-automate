...
Public Interface IServiceCliente
    ...
    <OperationContract()>
    Sub Insert_Single(ByVal pBeCliente As clsBeCliente)
    ...
    <OperationContract()>
    Function Max_IdCliente() As Integer

    <OperationContract()>
    Function Update_Single(pBeCliente As clsBeCliente) As Integer

    <OperationContract()>
    Function Existe(Cliente As String) As clsBeCliente
