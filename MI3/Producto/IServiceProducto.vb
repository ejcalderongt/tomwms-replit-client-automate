...
Public Interface IServiceProducto
    ...
    <OperationContract()>
    Sub Insert_Single(ByVal BeProducto As clsBeProducto)
    ...
    <OperationContract()>
    Function Get_Rep_Stock_Minimo() As List(Of clsBeReabasto)
    ...
    <OperationContract()>
    Function Get_All_Presentaciones_By_IdProducto(ByVal pIdProducto As Integer, ByVal pIdBodega As Integer) As List(Of clsBeProducto_Presentacion)
    ...
    <OperationContract()>
    Function Get_All_Rellenado_Producto_By_IdProducto(ByVal IdProducto As Integer) As List(Of clsBeProducto_rellenado)

    <OperationContract()>
    Function Existe(ByVal Codigo As String) As clsBeProducto
