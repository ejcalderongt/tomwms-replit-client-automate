...
Public Class ServiceProductoBodega
    ...
    Public Function Exist_By_IdProducto_And_IdBodega(ByVal pIdProducto As Integer, ByVal pIdBodega As Integer) As Boolean Implements IServiceProductoBodega.Exist_By_IdProducto_And_IdBodega

        Try
            Return clsLnProducto_bodega.Exist_By_IdProducto_And_IdBodega(pIdProducto, pIdBodega)
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
    ...
    Public Function MaxID() As Integer Implements IServiceProductoBodega.MaxID

        Try
            Return clsLnProducto_bodega.MaxID()
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
