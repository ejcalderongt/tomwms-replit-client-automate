...
Public Class ServiceProductoClasificacion
    ...
    Public Function Exist_By_Codigo(ByVal Codigo As String) As Boolean Implements IServiceProductoClasificacion.Exist_By_Codigo

        Try

            Return clsLnProducto_clasificacion.Exist_By_Codigo(Codigo)
