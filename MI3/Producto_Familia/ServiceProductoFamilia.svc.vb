...
Public Class ServiceProductoFamilia
    ...
    Public Function Exist_By_Codigo(ByVal pCodigo As String) As Boolean Implements IServiceProductoFamilia.Exist_By_Codigo

        Try

            Return clsLnProducto_familia.Exists_By_Codigo(pCodigo)
