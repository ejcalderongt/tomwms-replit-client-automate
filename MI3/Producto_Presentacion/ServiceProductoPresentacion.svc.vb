' NOTE: You can use the "Rename" command on the context menu to change the class name "ServiceProductoPresentacion" in code, svc and config file together.
' NOTE: In order to launch WCF Test Client for testing this service, please select ServiceProductoPresentacion.svc or ServiceProductoPresentacion.svc.vb at the Solution Explorer and start debugging.
...
Public Class ServiceProductoPresentacion
    ...
    ''' <exception cref="FaultException"></exception>
    ''' <exception cref="System.Exception"></exception>
    Public Sub Delete_By_IdProducto(ByVal pIdProducto As Integer) Implements IServiceProductoPresentacion.Delete_By_IdProducto
    ...
    Public Function Delete_By_IdPresentacion(ByVal pIdPresentacion As Integer) As Boolean Implements IServiceProductoPresentacion.Delete_By_IdPresentacion

        Delete_By_IdPresentacion = False

        Try

            Dim BeProductoPresentacion As New clsBeProducto_Presentacion
            BeProductoPresentacion.IdPresentacion = pIdPresentacion

            Delete_By_IdPresentacion = (clsLnProducto_presentacion.Eliminar(BeProductoPresentacion) > 0)
    ...
    '        Return clsLnProducto_presentacion.GetAllByProducto(pIdProducto, pActivo)
    ...
    ''' <summary>
    ''' Obtiene el IdPresentacion a partir del codigo_barra de la tabla producto_presentafcion
    ''' </summary>
    ''' <param name="pCodigo">Código de barra de la presentación</param>
    ''' <returns>IdPresentacion (int)</returns>
    Public Function Get_IdPresentacion_By_Codigo(ByVal pCodigo As String) As Integer Implements IServiceProductoPresentacion.Get_IdPresentacion_By_Codigo

        Get_IdPresentacion_By_Codigo = 0

        Try

            Return clsLnProducto_presentacion.Get_IdPresentacion_By_Codigo_Barra(pCodigo)
    ...
    Public Function Get_All_Activos_By_IdProducto(pIdProducto As Integer, pActivo As Boolean) As List(Of clsBeProducto_Presentacion) Implements IServiceProductoPresentacion.Get_All_Activos_By_IdProducto
