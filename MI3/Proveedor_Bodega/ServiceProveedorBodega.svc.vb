...
Public Class ServiceProveedorBodega
    ...
    ''' <summary>
    ''' Inserts the specified be proveedor bodega.
    ''' </summary>
    ''' <param name="BeProveedorBodega">The be proveedor bodega.</param>
    ''' <returns>System.Int32.</returns>
    ''' <exception cref="FaultException"></exception>
    ''' <exception cref="Exception"></exception>
    Public Function Insert(ByRef BeProveedorBodega As clsBeProveedor_bodega) As Integer Implements IServiceProveedorBodega.Insert

        Try
            Return clsLnProveedor_bodega.Insertar(BeProveedorBodega)
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
    ...
    ''' <exception cref="FaultException"></exception>
    ''' <exception cref="System.Exception"></exception>
    Public Function MaxIdProveedorBodega() As Integer Implements IServiceProveedorBodega.MaxIdProveedorBodega

        Try
            Return clsLnProveedor_bodega.MaxID()
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
