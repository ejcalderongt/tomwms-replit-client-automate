...
Public Class ServiceUnidadMedida
    ...
    Public Function Exist_By_Codigo(ByVal pCodigo As String) As Boolean Implements IServiceUnidadMedida.Exist_By_Codigo

        Try
            Return clsLnUnidad_medida.Existe_By_Codigo(pCodigo)
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
    ...
    Public Function Get_Single_By_Nombre(ByVal pNombreUM As String) As clsBeUnidad_medida Implements IServiceUnidadMedida.Get_Single_By_Nombre

        Try
            Return clsLnUnidad_medida.GetUnidadMedidaByNombre(pNombreUM)
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
