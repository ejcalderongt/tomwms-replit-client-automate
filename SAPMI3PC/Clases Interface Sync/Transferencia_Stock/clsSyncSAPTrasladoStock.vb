...
Public Class clsSyncSAPTrasladoStock : Inherits clsInterfaceBase
    ...
    Public Function Procesar_Traslados_SAP(ByVal BeI_nav_config_enc As clsBeI_nav_config_enc,
        ...
        Try
            ...
            If Not BeBodega Is Nothing Then
                ...
                lTrasladosSAP = Get_Traslados_SAP(BeBodega.Codigo)
                ...
                For Each TrasladoSAP In lTrasladosSAP
                    ...
                    If vBodegaOrigenEsWMS AndAlso vBodegaDestinoEsWMS Then
                        ...
                        clsPublic.Actualizar_Progreso(lblprg, $"El traslado es entre las bodegas de SAP: {TrasladoSAP.Transfer_from_Name} a {TrasladoSAP.Transfer_to_Name} que existen en wms, (se generará la tarea de cambio de ubicación).")
                    ...
                    Else
                        ...
                        clsPublic.Actualizar_Progreso(lblprg, "No se pudo procesar el traslado " & TrasladoSAP.No)
            ...
            Else
                ...
                If oTransferenciaStock.GetByKey(pNoDocumento) Then
                    ...
                    Try
                        ...
                        oTransferenciaStock.UserFields.Fields.Item("U_EnviadoWMS").Value = EstadoEnvio
    ...
    End Function
    Private Function Get_Traslados_SAP(ByVal pCodigoBodegaInterface As String) As List(Of clsBeI_nav_ped_traslado_enc)
            ...
            Else
                ...
                Dim SAP_Traslados As String = "SELECT DISTINCT T0.DocEntry,
                                               ...
                                               FROM OWTR T0 INNER JOIN 
                                                    WTR1 T1 ON T0.docentry = T1.docentry INNER JOIN 
        ...
        Try
            ...
            If Not BeConfigEnc Is Nothing Then
                ...
                If Not Pregunta_Si_LLena_Intermedia Then
                    ...
                    If Not Procesar_Traslados_SAP(BeConfigEnc, lblprg, prg, CnnLog) Then
                        Exit Function
                    End If
