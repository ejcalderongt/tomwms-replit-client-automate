...
Module ModuleMain
    ...
    Private Function Init_App(Optional ByVal EsInterface As Boolean = False) As Boolean
        ...
        Try
            ...
            Else
                ...
                lInstancias = clsPublic.Leer_Archivo_Configuracion_Ini(IndiceInstanciaDefecto, EsInterface)
                ...
                Else
                    ...
                    ''#EJC20240615: Buscar la instancia desde argumento, nombre.
                    'If gNombreInstancia <> "" Then
                    '    IndiceInstanciaDefecto = lInstancias.FindIndex(Function(x) x.NombreInstancia = gNombreInstancia)
                    'Else
                    '    gNombreInstancia = lInstancias(IndiceInstanciaDefecto).NombreInstancia
                    'End If
