    ...
    Private Sub Cargar_Datos()
        ...
        Try
            ...
            If Not dtSAPB1 Is Nothing Then
                ...
                dtReporteComparativo = clsLnTrans_inv_teorico_erp.Get_Inventario_Vrs_Stock_Det_ERP(BeConfigEnc.Idbodega)
    ...
    Public Function Get_Existencias_From_SAP_AsDataTable(ByVal IdBodega As Integer, ByVal IdUsuarioAgr As Integer) As DataTable
        ...
        Try
            ...
            If Conectar_A_SAP(oCompany, False, lErrCode, sErrMsg) Then
                ...
                Dim query As String = "SELECT Codigo,Cantidad_Lote, Lote, Fecha_Vence,Codigo_Bodega codigo_area
                ...
                While Not oRecordset.EoF
                    ...
                    BeInvTeoricoERP.IdUnidadMedida = clsLnUnidad_medida.Get_IdUnidadMedida_By_Codigo("UN", cTrans.lConnection, cTrans.lTransaction)
                    BeInvTeoricoERP.Lote = oRecordset.Fields.Item("Lote").Value
                    BeInvTeoricoERP.Fecha_vence = oRecordset.Fields.Item("Fecha_Vence").Value
                    BeInvTeoricoERP.Codigo = oRecordset.Fields.Item("Codigo").Value
                    ...
                    SplashScreenManager.Default.SetWaitFormDescription("Código: " & BeInvTeoricoERP.Codigo & " Lote " & BeInvTeoricoERP.Lote)
