...
Public Class clsSyncSAPProveedor : Inherits clsInterfaceBase
        ...
        Try
            ...
            query_sap = "SELECT T0.CARDCODE AS CODIGO,
                        ...
                        WHERE (T0.CARDTYPE = 'S' and T0.validFor = 'Y' 
                               AND  T0.SERIES IN (78,85,87) AND T0.groupcode in (104,103))
                               AND (t0.U_Enviado_WMS= '2' OR 
                                    t0.UpdateDate BETWEEN DATEADD(DAY,-" & BeConfigEnc.Rango_Dias_Importacion & ",convert(date,GETDATE())) AND convert(date,GETDATE())) "
    ...
    Public Shared Function Get_Proveedor_SAP(ByVal pCodigo As String) As clsBeI_nav_proveedor
        ...
        Try
            ...
            Dim query_sap As String = "SELECT T0.CARDCODE AS CODIGO,
                                              ...
                                              T0.SERIES IN (78,85, 87) And 
                                              T0.groupcode in (104,103)) "
    ...
    Public Function Insertar_Clientes_Desde_Tabla_Intermedia_A_Tabla_TOMWMS(ByRef lblprg As RichTextBox,
                                                                               ByRef prg As ProgressBar,
                                                                               Optional ByVal ForzarEjecucion As Boolean = False,
                                                                               Optional ByVal Pregunta_Si_LLena_Intermedia As Boolean = False) As Boolean
        ...
        Try
            ...
            Dim lClientesFromSAP As New List(Of clsBeI_nav_cliente)

            clsPublic.Actualizar_Progreso(lblprg, "Consultando clientes en tabla intermedia ")

            lClientesFromSAP = clsLnI_nav_cliente.Get_All(CnnInterface, lTransInterface)

            clsPublic.Actualizar_Progreso(lblprg, String.Format("Clientes en tabla intermedia: {0}", lClientesFromSAP.Count))

            If lClientesFromSAP.Count > 0 Then
                ...
                prg.Maximum = lClientesFromSAP.Count
                ...
                If Not lClientesFromSAP Is Nothing Then

                    If lClientesFromSAP.Count > 0 Then

                        clsPublic.Actualizar_Progreso(lblprg, "Trasladando documento a TOMWMS.")

                        For Each navProveedor As clsBeI_nav_cliente In lClientesFromSAP

                            BeCliente = New clsBeCliente
                            BeClienteExistente = New clsBeCliente

                            BeClienteExistente = clsLnCliente.Get_Single_By_Codigo(navProveedor.No, CnnInterface, lTransInterface)
                            ...
                            If Not BeClienteExistente Is Nothing Then
                                ...
                                BeCliente.Codigo = navProveedor.No
                                BeCliente.Nombre_comercial = navProveedor.Name
                                BeCliente.Telefono = navProveedor.Phone_No
                                BeCliente.Nit = navProveedor.VAT_Registratrion_No
                                BeCliente.Direccion = navProveedor.Adress
                                BeCliente.Nombre_contacto = navProveedor.ContactName
                                ...
                                Catch ex As Exception
                                    ...
                                    clsPublic.Actualizar_Progreso(lblprg, String.Format("Error al actualizar proveedor: {0}{1}{2}", BeCliente.Codigo, vbNewLine, vMensaje))
                                ...
                                Try
                                    ...
                                    'Marcar_Enviado_SAP
                                    Marcar_Proveedor_Sincronizado_SAP(BeCliente.Codigo)
                                ...
                                Catch ex As Exception
                                    ...
                                    clsPublic.Actualizar_Progreso(lblprg, String.Format("Error al actualizar proveedor en SAP: {0}{1}{2}", BeCliente.Codigo, vbNewLine, vMensaje))
                            ...
                            Else
                                ...
                                Try
                                    ...
                                    clsLnCliente.Insertar(BeCliente, CnnInterface, lTransInterface)

                                    VContadorBitacoraTOMWMS += 1

                                    BeClienteBodega = clsLnCliente_bodega.GetSingle(BeCliente.IdCliente, BeConfigEnc.Idbodega, CnnInterface, lTransaction:=lTransInterface)
                                    ...
                                    If BeClienteBodega Is Nothing Then
                                        ...
                                        clsLnCliente_bodega.Insertar(BeClienteBodega, CnnInterface, lTransInterface)
                                ...
                                Catch ex As Exception
                                    ...
                                    clsPublic.Actualizar_Progreso(lblprg, String.Format("Error al insertar cliente: {0}{1}{2}", BeCliente.Codigo, vbNewLine, ex.Message))
                                ...
                                Catch ex As Exception
                                    ...
                                    clsPublic.Actualizar_Progreso(lblprg, String.Format("Error al actualizar cliente en SAP: {0}{1}{2}", BeCliente.Codigo, vbNewLine, vMensaje))
    ...
    Private Function Importar_Clientes_Desde_SAP_A_TablaIntermedia(ByVal lblprg As RichTextBox,
                                                                       ByRef prg As ProgressBar,
                                                                       ByRef cnnLog As SqlConnection) As Boolean
        ...
        Try
            ...
            clsPublic.Actualizar_Progreso(lblprg, "Consultando clientes nuevos en SAP.")

            lClientes = Get_Clientes_SAP()
            ...
            clsPublic.Actualizar_Progreso(lblprg, String.Format("clientes encontrados en WS: {0} ", lClientes.Count & vbNewLine))
            ...
            For Each Cli In lClientes
                ...
                Try
                    ...
                    clsPublic.Actualizar_Progreso(lblprg, String.Format("Procesando cliente: {0} ", Cli.No, vbNewLine))

                    clsLnI_nav_cliente.Insertar(Cli, lConnection, lTransaction)
                ...
                Catch ex As Exception
                    ...
                    clsPublic.Actualizar_Progreso(lblprg, "Error al insertar desde SAP a intermedia: " & Cli.No & vbNewLine &
                                                   ex.Message)
    ...
    Public Shared Function Get_Clientes_SAP() As List(Of clsBeI_nav_cliente)

        Get_Clientes_SAP = Nothing
        ...
        Try
            ...
            query_sap = "SELECT T0.CARDCODE AS CODIGO,
                        ...
                        T0.E_Mail, T0.GroupCode
                        FROM OCRD T0 LEFT JOIN OCPR T1 ON T0.CardCode = T1.CardCode
                        WHERE (T0.CARDTYPE = 'S' and T0.validFor = 'Y' AND t0.U_Enviado_WMS= '2' AND Series = 78 and GroupCode = 103)"
            ...
            Else
                ...
                Dim BeINAVCliente As clsBeI_nav_cliente

                While rs.EoF = False

                    BeINAVCliente = New clsBeI_nav_cliente()
                    BeINAVCliente.No = (rs.Fields.Item(0).Value.ToString())
                    BeINAVCliente.Name = (rs.Fields.Item(1).Value.ToString())
                    BeINAVCliente.Phone_No = (rs.Fields.Item(2).Value.ToString())
                    BeINAVCliente.ContactName = (rs.Fields.Item(3).Value.ToString())
                    BeINAVCliente.VAT_Registratrion_No = (rs.Fields.Item(4).Value.ToString())
                    BeINAVCliente.Adress = (rs.Fields.Item(5).Value.ToString())
                    BeINAVCliente.Search_Name = (rs.Fields.Item(6).Value.ToString())
                    lReturnList.Add(BeINAVCliente)
