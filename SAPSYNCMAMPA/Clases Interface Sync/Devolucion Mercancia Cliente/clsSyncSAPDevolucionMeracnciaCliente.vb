...
Public Class clsSyncSAPDevolucionMeracnciaCliente : Inherits clsInterfaceBase
    ...
    Public Shared Async Function Inserta_Cliente_Como_Proveedor_Desde_SAPAsync(ByVal pCodigo As String,
                                                                               ByVal cnnLog As SqlConnection) As Task(Of Boolean)

        Try

            Dim cliente As clsBeI_nav_cliente = Await clsSyncSAPCliente.Get_Cliente_SAP_SLAsync(vHanaService.SessionCookie,
    ...
    '    Public Async Function Insertar_NC_Cliente_Desde_Tabla_Intermedia_A_Tabla_TOMWMS(ByVal lblprg As RichTextBox,
    ...
    '                Dim inserted As Boolean = Await Importar_Devolucion_Cliente_SAP_A_TI_WMSAsync(lblprg, prg, CnnLog)
    ...
    '                                    If Await Inserta_Proveedor_Desde_SAP(navPedidoCompraEnc.Buy_From_Vendor_No,
    '                                                                         vHanaService.SessionCookie,
    '                                                                         BD.Instancia.HANA_SL) Then
    '                                        clsPublic.Actualizar_Progreso(lblprg, vbTab & "El proveedor: " & navPedidoCompraEnc.Buy_From_Vendor_No & " No existía en WMS y fue insertado.")
    '                                    End If
