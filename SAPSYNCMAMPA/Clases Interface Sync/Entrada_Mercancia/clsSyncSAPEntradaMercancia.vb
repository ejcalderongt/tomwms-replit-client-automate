...
Public Class clsSyncSAPEntradaMercancia : Inherits clsInterfaceBase
    ...
    Public Function Importar_Entrada_Mercancia_Desde_SAP_A_TablaIntermedia(ByVal lblprg As RichTextBox,
        ...
        Try
            ...
            If clsLnI_nav_ped_compra_det.EliminarTodos(lConnection, lTransaction) _
                ...
                For Each PC In lPedidosCompra
                    ...
                    Actualizar_Progreso(lblprg, String.Format("Procesando Pedido Compra: {0} ", PC.No, vbNewLine))
        ...
        Catch ex As Exception
            ...
            lblprg.AppendText(String.Format("Error al insertar Ordenes de Compra desde SAP a intermedia: {0}{1}", vbNewLine, ex.Message))
    ...
    Private Function Inserta_Proveedor_Desde_SAP(ByVal pCodigo As String,
        ...
        Try
            ...
            BeINavProveedor = clsSyncSAPProveedor.Get_Proveedores_SAP_Hana(pCodigo)
            ...
            If lPedidoCompraEnc.Count > 0 Then
                ...
                For Each navPedidoCompraEnc As clsBeI_nav_ped_compra_enc In lPedidoCompraEnc
                    ...
                    If navPedidoCompraEnc.Status <> 0 Then
                        ...
                        Actualizar_Progreso(lblprg, String.Format("Procesando O.C.: {0} ", navPedidoCompraEnc.No, vbNewLine))
                            ...
                            Case 1 'Es un pedido de compra de proveedor.
                                ...
                                Else
                                    ...
                                    Try
                                        ...
                                        Actualizar_Progreso(lblprg, String.Format("Se registró el pedido:{0} correctamente en el ERP.", PC.No_pedido))
                                    ...
                                    Catch ex As Exception
                                        ...
                                        Else
                                            ...
                                            Actualizar_Progreso(lblprg, String.Format("Error al registrar pedido {0} en NAV: {1}", PC.No_pedido, ex.Message))
