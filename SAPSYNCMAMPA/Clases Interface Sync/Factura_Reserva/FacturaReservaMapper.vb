        ...
        For Each linea As JObject In documentLines
            If linea("LineStatus")?.ToString() = "bost_Open" Then
                Dim d As New clsBeI_nav_ped_compra_det() With {
                    ...
                    .Quantity = Convert.ToDecimal(linea("RemainingOpenQuantity")),'Convert.ToDecimal(linea("RemainingOpenQuantity")),
                    .Quantity_Received = 0,
                    ...
                    .Barcode = $"{linea("ItemCode")}{linea("U_Talla")}{linea("U_Color")}",
                    .Type = 2,
