...
Public Class clsSyncSAPPedidoCompra : Inherits clsInterfaceBase
    ...
    Private Function Producto_En_SAP_Tiene_Control_Lote(ByVal ProductCode As String) As Boolean
        ...
        Try
            ...
            Dim oItems As Items = oCompany.GetBusinessObject(BoObjectTypes.oItems)
                ...
                If oOrderPurchase.GetByKey(_Docentry) Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            clsLnLog_error_wms.Agregar_Error("LOG20241027b: Se actualizó el documento en sap: " & vMensajeResultado)
                        End If
        ...
        Try
            ...
            Select Case beTransOCEnc.TipoIngreso.IdTipoIngresoOC
                ...
                Case tTipoDocumentoIngreso.Devolucion
                    ...
                    If oOrderPurchase IsNot Nothing AndAlso oOrderPurchase.GetByKey(_Docentry) Then
                        Procesar_Detalle_Ingreso_Devolucion(oOrderPurchase, beTransOCEnc.TipoIngreso.IdTipoIngresoOC, lINavTransaccionesOut, _Docentry, lblPrg)
                    Else
                        clsPublic.Actualizar_Progreso(lblPrg, "ERROR_202311212019: No se pudo obtener el documento de devolución de sap para el _Docentry: " & _Docentry)
                    End If
    ...
    Private Shared Function Procesar_Detalle_Ingreso_Estado(ByVal oOrderPurchase As Documents,
        ...
        Dim clsTransaccion As New clsTransaccion
        Procesar_Detalle_Ingreso_Estado = False
            ...
            For Each Estado In EstadosRecibidos
                    ...
                    If DistinctProductosLineas.Any() Then
                        ...
                        For Each ProductoIngreso In DistinctProductosLineas
                            ...
                            If nuevaLineaEntrega Then
                                ...
                                '#CKFK20240509 Cambié el valor de IVA por EXE
                                oEntrega.Lines.TaxCode = vTipoImpuesto
                                oEntrega.Lines.UserFields.Fields.Item("U_ENVIADO_WMS").Value = "1"
                ...
                If vAgregarEntrega Then
                    ...
                    Else
                        ...
                        Procesar_Detalle_Ingreso_Estado = True
    ...
    Private Shared Function Procesar_Detalle_Ingreso_Devolucion_Estado(ByVal oReturnRequest As Documents,
                                                                       ByVal pTipoDocumento As clsDataContractDI.tTipoDocumentoIngreso,
                                                                       ByVal lINavTransaccionesOut As List(Of clsBeI_nav_transacciones_out),
                                                                       ByVal _Docentry As Integer,
                                                                       ByRef lblPrg As RichTextBox) As Boolean
        ...
        Procesar_Detalle_Ingreso_Devolucion_Estado = False
            ...
            For Each Estado In EstadosRecibidos
                                    ...
                                    If LotesRecibidosPorEstado.Count > 0 Then
                                        ...
                                        For Each LoteAgrupadoPorEstado In LotesRecibidosPorEstado
                                            ...
                                            For Each Lote In LoteAgrupadoPorEstado.Lotes
                                                ...
                                                oReturn.Lines.BatchNumbers.Quantity = Lote.CantidadTotal
                ...
                If vAgregarEntrega Then
                    ...
                    Else
                        ...
                        Procesar_Detalle_Ingreso_Devolucion_Estado = True
                        ...
                        clsPublic.Actualizar_Progreso(lblPrg, "#MSG2407152241: Se creó el traslado con DocEntry: " & vTrasladoDocEntry & "para la bodega:  " & vCodigoBodegaERP)
...
BeNavEjecucionEnc.IdEjecucionEnc,
    ...
    Private Shared Function Detalle_Tiene_Diferencia_Vrs_OC(ByVal pObjOC As clsBeTrans_oc_enc,
                                                     ...
                                                     pListRecepcionDetalle As List(Of clsBeTrans_re_det)) As Boolean
