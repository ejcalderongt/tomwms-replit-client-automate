...
Public Class clsSyncSAPPedidoTraslado : Inherits clsInterfaceBase
    ...
    Public Function Procesar_Salidas_Desde_SAP(ByVal lblprg As RichTextBox,
        ...
        Try
            ...
            For Each PC In lPedidosTraslado
                ...
                Actualizar_Progreso(lblprg, String.Format("Procesando Pedido de Cliente: {0}/{1}{2}", PC.No, PC.Receipt_Document_Reference, vbNewLine))
                ...
                clsLnI_nav_ped_traslado_enc.Importar_Pedido_Cliente_A_Tabla_Intermedia(PC, Resultado)
    ...
    Public Function Importar_Pedido_Cliente_SAP(ByRef lblprg As RichTextBox,
        ...
        Catch ex As Exception
            ...
            Actualizar_Progreso(lblprg, String.Format("Error al insertar pedido de traslado a tabla de TOMWMS: {1} {0} {1}", ex.Message, vbNewLine))
            Throw ex
        Finally
