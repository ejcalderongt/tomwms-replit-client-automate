...
Public Class clsSyncSapCodigosBarra : Inherits clsInterfaceBase
    ...
    Private Function Get_Codigos_Barra_Productos_From_SAP_ant() As List(Of clsBeI_nav_producto)

        Get_Codigos_Barra_Productos_From_SAP_ant = Nothing
        ...
        Try
            ...
            query_sap = "Select * from dbo.CBR_Alias_V "
            ...
            If Conectar_A_SAP(oCompany, False, lErrCode, sErrMsg) Then
                ...
                Get_Codigos_Barra_Productos_From_SAP_ant = lReturnList
