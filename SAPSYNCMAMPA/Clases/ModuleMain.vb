    ...
    Sub Main(ByVal Args As String())
        ...
        Try
            ...
            If Args.Length = 0 Then
                ...
                MenuPrincipal = New frmMenu(CInt(IdConfiguracion))
            ...
            Else
                ...
                If InterfaceAEjecutar = "" Then
                    MenuPrincipal = New frmMenu(CInt(IdConfiguracion))
                Else
                    MenuPrincipal = New frmMenu(InterfaceAEjecutar, CInt(IdConfiguracion), CInt(IdUsuario))
                End If
        ...
        Try
            ...
            Else
                ...
                If InterfaceAEjecutar = "" Then
                    MenuPrincipal = New frmMenu(CInt(IdConfiguracion))
                Else
                    MenuPrincipal = New frmMenu(InterfaceAEjecutar, CInt(IdConfiguracion))
                End If
