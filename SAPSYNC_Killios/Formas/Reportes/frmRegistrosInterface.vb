...
Public Class frmRegistrosInterface
    ...
    Private Sub SetDatataTable()
        ...
        DT.Columns.Add("No. PedidoEnc", GetType(Integer))
        DT.Columns.Add("No. DespachoEnc", GetType(Integer))
        ...
        DT.Columns.Add("No. Pedido", GetType(String))
        ...
        DT.Columns.Add("Fecha Tarea", GetType(Date))
        ...
        Try
            ...
            If ListRegistros.Count > 0 Then
                ...
                For Each Obj As clsBeI_nav_transacciones_out In ListRegistros
                    ...
                    DT.Rows.Add(Obj.Idtransaccion, Obj.Idordencompra, Obj.Idrecepcionenc, Obj.Idpedidoenc, Obj.Iddespachoenc,
                                Obj.No_linea, Obj.Codigo_producto, Obj.Nombre_producto, Obj.Unidad_medida, Presentacion.Nombre, Obj.Tipo_transaccion,
                                Obj.No_pedido, Obj.Lote, VCantidadUMbas, vCantidadPres, Obj.Peso, Obj.Fecha_vence, Obj.Fecha_recepcion, Obj.Enviado)
                Next
