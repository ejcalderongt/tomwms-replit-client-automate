...
Public Class frmLicSolicitud
    ...
    Public sitem As clsBeLicencia_item
    ...
    Private Sub Activa_Licencia()
        ...
        Try
            ...
            If sitem.Tipo = clsBeLicencia_item.eTipoHost.BOF Then
                ...
                rslt = clsLnLicencia_item.Aplica_Solicitud(lmac, cLic, Bandera, False)
            Else
                cLic.IdDisp = sitem.IdDisp
                rslt = clsLnLicencia_item.Aplica_SolicitudHH(lmac, cLic, Bandera, False)
            End If
