...
Public Class clsLnI_nav_acuerdo_productos

    Public Shared Sub Cargar(ByRef oBeI_nav_acuerdo_productos As clsBeI_nav_acuerdo_productos, ByRef dr As DataRow)
        Try
            With oBeI_nav_acuerdo_productos
    ...
    Public Shared Function Insertar(ByRef oBeI_nav_acuerdo_productos As clsBeI_nav_acuerdo_productos, Optional ByVal pConection as SqlConnection = Nothing, Optional Byval pTransaction as SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            Ins.Init("i_nav_acuerdo_productos")
            ...
            cmd.Parameters.Add(New SqlParameter("@COD_EMPRESA", oBeI_nav_acuerdo_productos.Cod_empresa))
            cmd.Parameters.Add(New SqlParameter("@CODIGOPRODUCTO", oBeI_nav_acuerdo_productos.Codigoproducto))
            cmd.Parameters.Add(New SqlParameter("@DESCRIPCION", oBeI_nav_acuerdo_productos.Descripcion))
            cmd.Parameters.Add(New SqlParameter("@NEMONICO", oBeI_nav_acuerdo_productos.Nemonico))
            cmd.Parameters.Add(New SqlParameter("@CODIGO_RUBRO", oBeI_nav_acuerdo_productos.Codigo_rubro))
            cmd.Parameters.Add(New SqlParameter("@MOVIMIENTO", oBeI_nav_acuerdo_productos.Movimiento))
            cmd.Parameters.Add(New SqlParameter("@ESTADO", oBeI_nav_acuerdo_productos.Estado))
            cmd.Parameters.Add(New SqlParameter("@COD_CENTRO", oBeI_nav_acuerdo_productos.Cod_centro))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTAXCOBRAR", oBeI_nav_acuerdo_productos.Cod_cuentaxcobrar))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTAPRODUCTO", oBeI_nav_acuerdo_productos.Cod_cuentaproducto))
            cmd.Parameters.Add(New SqlParameter("@USUARIO", oBeI_nav_acuerdo_productos.Usuario))
            cmd.Parameters.Add(New SqlParameter("@FECHAMOV", oBeI_nav_acuerdo_productos.Fechamov))
            cmd.Parameters.Add(New SqlParameter("@CONTROL", oBeI_nav_acuerdo_productos.Control))
            cmd.Parameters.Add(New SqlParameter("@CORRELATIVO", oBeI_nav_acuerdo_productos.Correlativo))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTAPASIVODIFERIDO", oBeI_nav_acuerdo_productos.Cod_cuentapasivodiferido))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTA_DIF_CXC", oBeI_nav_acuerdo_productos.Cod_cuenta_dif_cxc))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTA_DIF_PASDIF", oBeI_nav_acuerdo_productos.Cod_cuenta_dif_pasdif))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTAXCOBRAR_ME", oBeI_nav_acuerdo_productos.Cod_cuentaxcobrar_me))
            cmd.Parameters.Add(New SqlParameter("@COD_CUENTAPASIVODIFERIDO_ME", oBeI_nav_acuerdo_productos.Cod_cuentapasivodiferido_me))
            cmd.Parameters.Add(New SqlParameter("@CORRE_CBCESANTES", oBeI_nav_acuerdo_productos.Corre_cbcesantes))
            cmd.Parameters.Add(New SqlParameter("@MONTOMINIMO", oBeI_nav_acuerdo_productos.Montominimo))
    ...
    Public Shared Function Actualizar(ByRef oBeI_nav_acuerdo_productos As clsBeI_nav_acuerdo_productos, Optional ByVal pConection As SqlConnection = Nothing, Optional ByVal pTransaction As SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            Upd.Init("i_nav_acuerdo_productos")
    ...
    Public Shared Function Existe(ByVal pCodigo As String,
        ...
        Try
            ...
            Dim vSQL As String = "SELECT * FROM i_nav_acuerdo_productos WHERE codigoproducto= @Codigo"
    ...
    Public Shared Function Eliminar(ByRef oBeI_nav_acuerdo_productos As clsBeI_nav_acuerdo_productos, Optional ByVal pConection As SqlConnection = Nothing, Optional ByVal pTransaction As SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            Const sp As String = " Delete from I_nav_acuerdo_productos"
    ...
    Public Shared Function Listar() As DataTable
        ...
        Try
            ...
            Const sp As String = "SELECT * FROM I_nav_acuerdo_productos"
            lConnection.Open() : lTransaction = lConnection.BeginTransaction()
    ...
    Public Shared Function GetAll() As List(Of clsBeI_nav_acuerdo_productos)

        Dim lReturnList As New List(Of clsBeI_nav_acuerdo_productos)
            ...
            Using lConnection As New SqlConnection(connectionString:=Configuration.ConfigurationManager.AppSettings("CST_ERP"))
                ...
                Using lTransaction As SqlTransaction = lConnection.BeginTransaction()
                    ...
                    Using lDTA As New SqlDataAdapter(sp, lConnection)
                        ...
                        Dim vBeI_nav_acuerdo_productos As New clsBeI_nav_acuerdo_productos

                        For Each dr As DataRow In lDataTable.Rows
                            vBeI_nav_acuerdo_productos = New clsBeI_nav_acuerdo_productos()
                            Cargar(vBeI_nav_acuerdo_productos, dr)
                            lReturnList.Add(vBeI_nav_acuerdo_productos)
                        Next
    ...
    Public Shared Sub GetSingle(ByRef pBeI_nav_acuerdo_productos As clsBeI_nav_acuerdo_productos)
                ...
                Using lTransaction As SqlTransaction = lConnection.BeginTransaction()
                    ...
                    Using lDTA As New SqlDataAdapter(sp, lConnection)
                        ...
                        If lDataTable IsNot Nothing AndAlso lDataTable.Rows.Count > 0 Then
                            Cargar(vBeI_nav_acuerdo_productos, lDataTable.Rows(0))
                        End If
