        ...
        Try
            ...
            If navPedidoCompraDet.Barcode <> "" Then
                ...
                If BeProductoTallaColor IsNot Nothing Then
                    ...
                    BePedidoCompraDet.Codigo_Producto = BeProductoTallaColor.CodigoSKU
                Else

                    Dim pProducto_Talla_color As New clsBeProducto_talla_color()
                    pProducto_Talla_color.IdProductoTallaColor = clsLnProducto_talla_color.MaxID(lConnection, lTransInterface) + 1
                    pProducto_Talla_color.IdColor = clsLnColor.GetSingle_By_CodigoColor(navPedidoCompraDet.Color, lConnection, lTransInterface).IdColor
                    pProducto_Talla_color.IdTalla = clsLnTalla.Get_Single_By_Codigo(navPedidoCompraDet.Size, lConnection, lTransInterface).IdTalla
                    pProducto_Talla_color.IdProducto = clsLnProducto.Get_Single_By_Codigo(navPedidoCompraDet.No, lConnection, lTransInterface).IdProducto
                    ...
                    pProducto_Talla_color.CodigoSKU = navPedidoCompraDet.No + navPedidoCompraDet.Color + navPedidoCompraDet.Size

                    clsLnProducto_talla_color.Insertar(pProducto_Talla_color, lConnection, lTransInterface)

                    BePedidoCompraDet.IdProductoTallaColor = pProducto_Talla_color.IdProductoTallaColor
                    BePedidoCompraDet.Codigo_Producto = pProducto_Talla_color.CodigoSKU
