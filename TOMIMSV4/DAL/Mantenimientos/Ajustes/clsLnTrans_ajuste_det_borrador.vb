...
Public Class clsLnTrans_ajuste_det_borrador
    ...
    Public Shared Function Insertar(ByRef oBeTrans_ajuste_det_borrador As clsBeTrans_ajuste_det_borrador,
        ...
        Try
            ...
            cmd.Parameters.Add(New SqlParameter("@IdProductoTallaColor_origen", oBeTrans_ajuste_det_borrador.IdProductoTallaColor_origen))
            cmd.Parameters.Add(New SqlParameter("@Talla_origen", IIf(oBeTrans_ajuste_det_borrador.Talla_origen Is Nothing, "", oBeTrans_ajuste_det_borrador.Talla_origen)))
            cmd.Parameters.Add(New SqlParameter("@Color_origen", IIf(oBeTrans_ajuste_det_borrador.Color_origen Is Nothing, "", oBeTrans_ajuste_det_borrador.Color_origen)))
            cmd.Parameters.Add(New SqlParameter("@IdProductoTallaColor_destino", oBeTrans_ajuste_det_borrador.IdProductoTallaColor_destino))
            cmd.Parameters.Add(New SqlParameter("@Talla_destino", IIf(oBeTrans_ajuste_det_borrador.Talla_destino Is Nothing, "", oBeTrans_ajuste_det_borrador.Talla_destino)))
            cmd.Parameters.Add(New SqlParameter("@Color_destino", IIf(oBeTrans_ajuste_det_borrador.Color_destino Is Nothing, "", oBeTrans_ajuste_det_borrador.Color_destino)))
