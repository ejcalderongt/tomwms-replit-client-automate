...
Partial Public Class clsLnRegla_ubic_det_ir
    Implements IDisposable

    Public Shared Function GetAllByIdReglaUbicacionEnc(ByVal IdReglaUbicacionEnc As Integer) As List(Of clsBeRegla_ubic_det_ir)
        ...
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                vBeRegla_ubic_det_ir.IsNew = False
    ...
    Public Shared Function Aplicar_Regla_Por_IndiceRotacion(ByVal IdBodega As Integer,
                                                            ByVal IdIndiceRotacion As Integer,
                                                            ByRef lConnection As SqlConnection,
                                                            ByRef lTransaction As SqlTransaction) As Boolean

        Aplicar_Regla_Por_IndiceRotacion = False

        Try

            Dim vSQL As String = "SELECT regla_ubic_enc.IdBodega, regla_ubic_det_ir.IdIndiceRotacion " &
                   " FROM regla_ubic_det_ir INNER JOIN " &
                   " regla_ubic_enc ON regla_ubic_det_ir.IdReglaUbicacionEnc = regla_ubic_enc.IdReglaUbicacionEnc " &
                   " Where(regla_ubic_enc.IdBodega = @IdBodega AND regla_ubic_det_ir.IdIndiceRotacion = @IdIndiceRotacion AND regla_ubic_det_ir.Activo = 1) "
            ...
            dad.SelectCommand.Parameters.Add(New SqlParameter("@IdIndiceRotacion", IdIndiceRotacion))
            Dim dt As New DataTable

            dad.Fill(dt)

            Aplicar_Regla_Por_IndiceRotacion = (dt.Rows.Count > 0)
