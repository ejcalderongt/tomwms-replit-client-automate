    ...
    Public Shared Function GuardarHH(ByVal pRecEnc As clsBeTrans_re_enc,
        ...
        Try
            ...
            If Not Finalizada(pRecEnc.IdRecepcionEnc, lConnection, lTransaction) Then
                ...
                '#GT05012026: si ya esta anulada, lanzar aviso en la HH.
                ...
                Else
                    Throw New Exception("ERROR_DE_PROCESO_26012026_HH: La recepción " & pRecEnc.IdRecepcionEnc & " fue previamente anulada.")
                End If
