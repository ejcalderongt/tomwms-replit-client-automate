...
Public Class clsLnTrans_ubic_hh_stock

    Public Shared Sub Cargar(ByRef oBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock, ByRef dr As DataRow)
        Try
            With oBeTrans_ubic_hh_stock
                .IdStockTransUbicHHDet = IIf(IsDBNull(dr.Item("IdStockTransUbicHHDet")), 0, dr.Item("IdStockTransUbicHHDet"))
                ...
                .Fecha_mov_hist = IIf(IsDBNull(dr.Item("fecha_mov_hist")), Date.Now, dr.Item("fecha_mov_hist"))
    ...
    Public Shared Function Insertar(ByRef oBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock, Optional ByVal pConection As SqlConnection = Nothing, Optional ByVal pTransaction As SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            cmd.Parameters.Add(New SqlParameter("@IDSTOCKTRANSUBICHHDET", oBeTrans_ubic_hh_stock.IdStockTransUbicHHDet))
            cmd.Parameters.Add(New SqlParameter("@IDTAREAUBICACIONENC", oBeTrans_ubic_hh_stock.IdTareaUbicacionEnc))
            cmd.Parameters.Add(New SqlParameter("@IDTAREAUBICACIONDET", oBeTrans_ubic_hh_stock.IdTareaUbicacionDet))
            cmd.Parameters.Add(New SqlParameter("@IDSTOCK", oBeTrans_ubic_hh_stock.IdStock))
            cmd.Parameters.Add(New SqlParameter("@IDPROPIETARIOBODEGA", oBeTrans_ubic_hh_stock.IdPropietarioBodega))
            cmd.Parameters.Add(New SqlParameter("@IDPRODUCTOBODEGA", oBeTrans_ubic_hh_stock.IdProductoBodega))
            cmd.Parameters.Add(New SqlParameter("@IDPRODUCTOESTADO", oBeTrans_ubic_hh_stock.IdProductoEstado))
            cmd.Parameters.Add(New SqlParameter("@IDPRESENTACION", IIf(oBeTrans_ubic_hh_stock.IdPresentacion = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdPresentacion)))
            cmd.Parameters.Add(New SqlParameter("@IDUNIDADMEDIDA", oBeTrans_ubic_hh_stock.IdUnidadMedida))
            cmd.Parameters.Add(New SqlParameter("@IDUBICACION", oBeTrans_ubic_hh_stock.IdUbicacion))
            cmd.Parameters.Add(New SqlParameter("@IDUBICACION_ANTERIOR", oBeTrans_ubic_hh_stock.IdUbicacion_anterior))
            cmd.Parameters.Add(New SqlParameter("@IDRECEPCIONENC", IIf(oBeTrans_ubic_hh_stock.IdRecepcionEnc = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdRecepcionEnc)))
            cmd.Parameters.Add(New SqlParameter("@IDRECEPCIONDET", IIf(oBeTrans_ubic_hh_stock.IdRecepcionDet = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdRecepcionDet)))
            cmd.Parameters.Add(New SqlParameter("@IDPEDIDOENC", IIf(oBeTrans_ubic_hh_stock.IdPedidoEnc = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdPedidoEnc)))
            cmd.Parameters.Add(New SqlParameter("@IDPICKINGENC", IIf(oBeTrans_ubic_hh_stock.IdPickingEnc = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdPickingEnc)))
            cmd.Parameters.Add(New SqlParameter("@IDDESPACHOENC", IIf(oBeTrans_ubic_hh_stock.IdDespachoEnc = 0, DBNull.Value, oBeTrans_ubic_hh_stock.IdDespachoEnc)))
            cmd.Parameters.Add(New SqlParameter("@LOTE", oBeTrans_ubic_hh_stock.Lote))
            cmd.Parameters.Add(New SqlParameter("@LIC_PLATE", oBeTrans_ubic_hh_stock.Lic_plate))
            cmd.Parameters.Add(New SqlParameter("@SERIAL", oBeTrans_ubic_hh_stock.Serial))
            cmd.Parameters.Add(New SqlParameter("@CANTIDAD", oBeTrans_ubic_hh_stock.Cantidad))
            cmd.Parameters.Add(New SqlParameter("@FECHA_INGRESO", oBeTrans_ubic_hh_stock.Fecha_ingreso))
            cmd.Parameters.Add(New SqlParameter("@FECHA_VENCE", oBeTrans_ubic_hh_stock.Fecha_vence))
            cmd.Parameters.Add(New SqlParameter("@UDS_LIC_PLATE", oBeTrans_ubic_hh_stock.Uds_lic_plate))
            cmd.Parameters.Add(New SqlParameter("@NO_BULTO", oBeTrans_ubic_hh_stock.No_bulto))
            cmd.Parameters.Add(New SqlParameter("@FECHA_MANUFACTURA", oBeTrans_ubic_hh_stock.Fecha_manufactura))
            cmd.Parameters.Add(New SqlParameter("@AÑADA", oBeTrans_ubic_hh_stock.Añada))
            cmd.Parameters.Add(New SqlParameter("@USER_AGR", oBeTrans_ubic_hh_stock.User_agr))
            cmd.Parameters.Add(New SqlParameter("@FEC_AGR", oBeTrans_ubic_hh_stock.Fec_agr))
            cmd.Parameters.Add(New SqlParameter("@USER_MOD", oBeTrans_ubic_hh_stock.User_mod))
            cmd.Parameters.Add(New SqlParameter("@FEC_MOD", oBeTrans_ubic_hh_stock.Fec_mod))
            cmd.Parameters.Add(New SqlParameter("@ACTIVO", oBeTrans_ubic_hh_stock.Activo))
            cmd.Parameters.Add(New SqlParameter("@PESO", oBeTrans_ubic_hh_stock.Peso))
    ...
    Public Shared Function Actualizar(ByRef oBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock, Optional ByVal pConection As SqlConnection = Nothing, Optional ByVal pTransaction As SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            Upd.Init("trans_ubic_hh_stock")
            Upd.Add("idstocktransubichhdet", "@idstocktransubichhdet", DataType.Parametro)
            ...
            Upd.Add("fecha_mov_hist", "@fecha_mov_hist", DataType.Parametro)
            Upd.Add("atributo_variante_1", "@atributo_variante_1", DataType.Parametro)
            Upd.Where("IdStockTransUbicHHDet = @IdStockTransUbicHHDet")
            ...
            cmd.Parameters.Add(New SqlParameter("@IDPRODUCTOBODEGA", oBeTrans_ubic_hh_stock.IdProductoBodega))
            cmd.Parameters.Add(New SqlParameter("@IDPRODUCTOESTADO", oBeTrans_ubic_hh_stock.IdProductoEstado))
            cmd.Parameters.Add(New SqlParameter("@IDPRESENTACION", oBeTrans_ubic_hh_stock.IdPresentacion))
            cmd.Parameters.Add(New SqlParameter("@IDUNIDADMEDIDA", oBeTrans_ubic_hh_stock.IdUnidadMedida))
            cmd.Parameters.Add(New SqlParameter("@IDUBICACION", oBeTrans_ubic_hh_stock.IdUbicacion))
            cmd.Parameters.Add(New SqlParameter("@IDUBICACION_ANTERIOR", oBeTrans_ubic_hh_stock.IdUbicacion_anterior))
            cmd.Parameters.Add(New SqlParameter("@IDRECEPCIONENC", oBeTrans_ubic_hh_stock.IdRecepcionEnc))
            cmd.Parameters.Add(New SqlParameter("@IDRECEPCIONDET", oBeTrans_ubic_hh_stock.IdRecepcionDet))
            cmd.Parameters.Add(New SqlParameter("@IDPEDIDOENC", oBeTrans_ubic_hh_stock.IdPedidoEnc))
            cmd.Parameters.Add(New SqlParameter("@IDPICKINGENC", oBeTrans_ubic_hh_stock.IdPickingEnc))
            cmd.Parameters.Add(New SqlParameter("@IDDESPACHOENC", oBeTrans_ubic_hh_stock.IdDespachoEnc))
            cmd.Parameters.Add(New SqlParameter("@LOTE", oBeTrans_ubic_hh_stock.Lote))
            cmd.Parameters.Add(New SqlParameter("@LIC_PLATE", oBeTrans_ubic_hh_stock.Lic_plate))
            cmd.Parameters.Add(New SqlParameter("@SERIAL", oBeTrans_ubic_hh_stock.Serial))
            cmd.Parameters.Add(New SqlParameter("@CANTIDAD", oBeTrans_ubic_hh_stock.Cantidad))
    ...
    Public Shared Function Eliminar(ByRef oBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock, Optional ByVal pConection As SqlConnection = Nothing, Optional ByVal pTransaction As SqlTransaction = Nothing) As Integer
        ...
        Try
            ...
            Const sp As String = " Delete from Trans_ubic_hh_stock" &
             "  Where(IdStockTransUbicHHDet = @IdStockTransUbicHHDet)"
    ...
    Public Shared Function EliminarTodos(Optional ByVal pConection As SqlConnection = Nothing,
    ...
    Public Shared Function Listar() As DataTable
        ...
        Try
            ...
            Const sp As String = "SELECT * FROM Trans_ubic_hh_stock"
            Dim lConnection As New SqlConnection(Configuration.ConfigurationManager.AppSettings("CST"))
    ...
    Public Shared Function Obtener(ByRef oBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock) As Boolean
        ...
        Try
            ...
            dad.SelectCommand.Parameters.Add(New SqlParameter("@IDSTOCKTRANSUBICHHDET", oBeTrans_ubic_hh_stock.IdStockTransUbicHHDet))

            Dim dt As New DataTable
            dad.Fill(dt)

            If dt.Rows.Count = 1 Then
                Cargar(oBeTrans_ubic_hh_stock, dt.Rows(0))
            Else
    ...
    Public Shared Function GetAll() As List(Of clsBeTrans_ubic_hh_stock)
    ...
    Public Shared Function GetSingle(ByRef pBeTrans_ubic_hh_stock As clsBeTrans_ubic_hh_stock)
        ...
        Try
            ...
            Dim cmd As New SqlCommand(sp, lConnection) With {.CommandType = CommandType.Text}
            Dim dad As New SqlDataAdapter(cmd)
            dad.SelectCommand.Parameters.Add(New SqlParameter("@IDSTOCKTRANSUBICHHDET", pBeTrans_ubic_hh_stock.IdStockTransUbicHHDet))

            Dim dt As New DataTable
            dad.Fill(dt)

            If dt.Rows.Count = 1 Then
                Cargar(pBeTrans_ubic_hh_stock, dt.Rows(0))
            End If
