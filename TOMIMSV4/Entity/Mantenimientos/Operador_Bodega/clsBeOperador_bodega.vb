Public Class clsBeOperador_bodega
    ...
    Sub New(ByRef IdOperadorBodega As Integer, ByVal IdOperador As Integer, ByVal IdBodega As Integer, ByVal activo As Boolean, ByVal user_agr As String, ByVal fec_agr As Date, ByVal user_mod As String, ByVal fec_mod As Date)
