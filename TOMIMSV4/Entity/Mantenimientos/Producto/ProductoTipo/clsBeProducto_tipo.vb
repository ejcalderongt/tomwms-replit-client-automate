...
Public Class clsBeProducto_tipo
    ...
    ''' <summary>
    ''' Gets or sets the nombre tipo producto.
    ''' </summary>
    ''' <value>The nombre tipo producto.</value>
    Public Property NombreTipoProducto() As String = ""
    ''' <summary>
    ''' Gets or sets a value indicating whether this <see cref="clsBeProducto_tipo"/> is activo.
    ''' </summary>
    ...
    ''' <summary>
    ''' Initializes a new instance of the <see cref="clsBeProducto_tipo"/> class.
    ''' </summary>
    Sub New()
    End Sub
    ...
    ''' <param name="NombreTipoProducto">The nombre tipo producto.</param>
    ...
    Sub New(ByRef IdTipoProducto As Integer, ByVal IdPropietario As Integer, ByVal NombreTipoProducto As String, ByVal Activo As Boolean, ByVal user_agr As String, ByVal fec_agr As Date, ByVal user_mod As String, ByVal fec_mod As Date)
