Public Class clsBeTrans_oc_pol
    ...
    Public Property Total_bultos_Peso_Neto As Double = 0
    ...
    Sub New(ByRef IdOrdenCompraPol As Integer, ByVal IdOrdenCompraEnc As Integer, ByVal bl_no As String,
            ByVal NoPoliza As String, ByVal pto_descarga As String, ByVal viaje_no As String,
            ByVal buque_no As String, ByVal remitente As String, ByVal fecha_abordaje As Date,
            ByVal destino As String, ByVal dir_destino As String, ByVal descripcion As String,
            ByVal po_number As String, ByVal cantidad As Integer, ByVal piezas As Integer,
            ByVal total_kgs As Double, ByVal cbm As Double, ByVal dua As String, ByVal fecha_poliza As Date,
            ByVal pais_procede As String, ByVal tipo_cambio As Double, ByVal total_valoraduana As Double,
            ByVal total_lineas As Integer, ByVal total_bultos As Integer, ByVal total_bultos_peso As Double,
            ByVal total_usd As Double, ByVal total_flete As Double, ByVal total_seguro As Double,
        ...
        Me.IdOrdenCompraPol = IdOrdenCompraPol
