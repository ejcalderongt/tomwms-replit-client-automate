...
Module m_Global
    ...
    Public Property gVersionApp As String = "8.9.14"  '#EJC20260529 mejora(lista-packing): +PorcentajePacking SQL
    Public Property gVersionWS As String = "8.9.14"  '#EJC20260529 versión WSHHRN TOMHHWS.asmx.vb
