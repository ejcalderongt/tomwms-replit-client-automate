...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("IMS4MBCalendar"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class IMS4MBCalendar
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As IMS4MBCalendar = CType(MyBase.Clone,IMS4MBCalendar)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "IMS4MBCalendar"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/IMS4MBCalendar.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As IMS4MBCalendar = New IMS4MBCalendar()
    ...
    Partial Public Class AppointmentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceID As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal Ubicacion As String) As AppointmentsRow
            Dim rowAppointmentsRow As AppointmentsRow = CType(Me.NewRow,AppointmentsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, Ubicacion}
    ...
    Partial Public Class ResourcesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddResourcesRow(ByVal ResourceID As Integer, ByVal ResourceName As String, ByVal Color As Integer, ByVal Image() As Byte, ByVal Ubicacion As String) As ResourcesRow
            Dim rowResourcesRow As ResourcesRow = CType(Me.NewRow,ResourcesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ResourceID, ResourceName, Color, Image, Ubicacion}
    ...
    Partial Public Class AppointmentsRow
        ...
        Public Property Ubicacion() As String
            Get
                Try 
                    Return CType(Me(Me.tableAppointments.UbicacionColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Ubicacion' de la tabla 'Appointments' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableAppointments.UbicacionColumn) = value
            End Set
        End Property
        ...
        Public Function IsUbicacionNull() As Boolean
            Return Me.IsNull(Me.tableAppointments.UbicacionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetUbicacionNull()
            Me(Me.tableAppointments.UbicacionColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class ResourcesRow
        ...
        Public Property Ubicacion() As String
            Get
                Try 
                    Return CType(Me(Me.tableResources.UbicacionColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Ubicacion' de la tabla 'Resources' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableResources.UbicacionColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function IsUbicacionNull() As Boolean
            Return Me.IsNull(Me.tableResources.UbicacionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetUbicacionNull()
            Me(Me.tableResources.UbicacionColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace IMS4MBCalendarTableAdapters
    ...
    Partial Public Class AppointmentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Appointments] ([Type], [StartDate], [EndDate], [AllDay], [Subj"& _ 
                ...
                " [ReminderInfo], [RecurrenceInfo], [Ubicacion]) VALUES (@Type, @StartDate, @EndD"& _ 
                "ate, @AllDay, @Subject, @Location, @Description, @Status, @Label, @ResourceID, @"& _ 
                "ResourceIDs, @ReminderInfo, @RecurrenceInfo, @Ubicacion);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UniqueID, Type"& _ 
                ", StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, Res"& _ 
                "ourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, Ubicacion FROM Appointments "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Appointments] SET [Type] = @Type, [StartDate] = @StartDate, [EndDat"& _ 
                ...
                "RecurrenceInfo] = @RecurrenceInfo, [Ubicacion] = @Ubicacion WHERE (([UniqueID] ="& _ 
                " @Original_UniqueID) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Or"& _ 
                "iginal_Type)) AND ((@IsNull_StartDate = 1 AND [StartDate] IS NULL) OR ([StartDat"& _ 
                "e] = @Original_StartDate)) AND ((@IsNull_EndDate = 1 AND [EndDate] IS NULL) OR ("& _ 
                "[EndDate] = @Original_EndDate)) AND ((@IsNull_AllDay = 1 AND [AllDay] IS NULL) O"& _ 
                ...
                "l, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, Ubicacion FROM Appoint"& _ 
                "ments WHERE (UniqueID = @UniqueID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description"& _ 
                ", Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, Ubicacio"& _ 
                "n FROM dbo.Appointments"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As IMS4MBCalendar.AppointmentsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As IMS4MBCalendar.AppointmentsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As IMS4MBCalendar.AppointmentsDataTable = New IMS4MBCalendar.AppointmentsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As IMS4MBCalendar.AppointmentsDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As IMS4MBCalendar) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Type As Global.System.Nullable(Of Integer), ByVal StartDate As Global.System.Nullable(Of Date), ByVal EndDate As Global.System.Nullable(Of Date), ByVal AllDay As Global.System.Nullable(Of Boolean), ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Global.System.Nullable(Of Integer), ByVal Label As Global.System.Nullable(Of Integer), ByVal ResourceID As Global.System.Nullable(Of Integer), ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal Ubicacion As String) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            Return Me.Update(Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, Ubicacion, Original_UniqueID, Original_Type, Original_StartDate, Original_EndDate, Original_AllDay, Original_Subject, Original_Location, Original_Status, Original_Label, Original_ResourceID, Original_UniqueID)
        End Function
    End Class
    ...
    Partial Public Class ResourcesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("CustomField1", "Ubicacion")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As IMS4MBCalendar.ResourcesDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As IMS4MBCalendar.ResourcesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As IMS4MBCalendar.ResourcesDataTable = New IMS4MBCalendar.ResourcesDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As IMS4MBCalendar.ResourcesDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As IMS4MBCalendar, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As IMS4MBCalendar, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._appointmentsTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As IMS4MBCalendar, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._resourcesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As IMS4MBCalendar) As Integer
