...
Public Class frmArancel_List
    ...
    Private Sub Listar_Aranceles()

        Try

            Dgrid.DataSource = Nothing

            Dim lista As New List(Of clsBeArancel)

            lista = clsLnArancel.Get_All_Filtro(chkActivos.Checked).ToList()

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("Arancel")
                DT.Columns.Add("IdArancel", GetType(Integer))
                DT.Columns.Add("Nombre", GetType(String))
                DT.Columns.Add("Porcentaje", GetType(Double))

                Parallel.ForEach(Lista, Sub(ByVal Obj)
                                            SyncLock DT
                                                DT.Rows.Add(Obj.IdArancel, Obj.Nombre, Obj.Porcentaje)
                                            End SyncLock
                                        End Sub)
                ...
                If (GridView1.Columns.Count <> 0) Then
                    ...
                    Try
                        GridView1.Columns("IdArancel").Caption = "Código"
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            Cierra_Instancia_Previa(frmArancel)

            With frmArancel
                .Modo = frmArancel.TipoTrans.Nuevo
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .Listar = AddressOf Listar_Aranceles
                .MdiParent = MdiParent
                .Show()
                .Focus()
            End With
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                gBeArancel = clsLnArancel.GetSingle(Dr.Item("IdArancel"))
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmArancel
                        .Modo = frmArancel.TipoTrans.Editar
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                        .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                        .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                        .gBeArancel = gBeArancel
                        .Listar = AddressOf Listar_Aranceles
                        .Show()
                        .Focus()
                    End With
    ...
    Private Sub frmArancel_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
