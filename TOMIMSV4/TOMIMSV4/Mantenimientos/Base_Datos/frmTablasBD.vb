...
Public Class frmTablasBD
    ...
    Private Sub Cargar_Datos()
        ...
        Try
            ...
            DT = TOMWMSSystemInfo.Get_Salud_Tablas_BD()
            ...
            If Not DT Is Nothing Then
                ...
                If DT.Rows.Count > 0 Then
                    ...
                    GridView1.Columns("Registros").SummaryItem.SummaryType = SummaryItemType.Sum
                    GridView1.Columns("Registros").SummaryItem.DisplayFormat = "{0:n0}"
                    GridView1.Columns("Registros").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView1.Columns("Registros").DisplayFormat.FormatString = "{0:n0}"

                    GridView1.Columns("EspacioTotalMB").SummaryItem.SummaryType = SummaryItemType.Sum
                    GridView1.Columns("EspacioTotalMB").SummaryItem.DisplayFormat = "{0:n2}"
                    GridView1.Columns("EspacioTotalMB").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView1.Columns("EspacioTotalMB").DisplayFormat.FormatString = "{0:n2}"

                    GridView1.Columns("Tabla").SummaryItem.SummaryType = SummaryItemType.Count
                    GridView1.Columns("Tabla").SummaryItem.DisplayFormat = "{0:n0}"
                    GridView1.Columns("Tabla").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView1.Columns("Tabla").DisplayFormat.FormatString = "{0:n0}"

                    GridView1.Columns("EspacioUsadoPorcentaje").SummaryItem.SummaryType = SummaryItemType.Sum
                    GridView1.Columns("EspacioUsadoPorcentaje").SummaryItem.DisplayFormat = "{0:n2}%"
                    GridView1.Columns("EspacioUsadoPorcentaje").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView1.Columns("EspacioUsadoPorcentaje").DisplayFormat.FormatString = "{0:n2}%"
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Salud de base de datos TOMWMS."
    ...
    Private Sub cmdExToExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdExToExcel.ItemClick
        Exportar_Grid_A_Excel(grdStockPorLote, "TOMWMS_SaludBD.xlsx")
    End Sub
    ...
    Private Sub frmTablasBD_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Try
            ...
            vNombreArchivoLayOutGrid = "grdSaludBD.xml"
