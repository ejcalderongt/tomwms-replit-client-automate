...
Public Class frmBodega_MuellesList
    ...
    Private Sub Listar_Muelles()

        Try
            '#GT18092024: se valida en el método que sino existen muelles retorno nothing
            Dgrid.DataSource = clsLnBodega_muelles.Listar(chkActivos.Checked, AP.Bodega.Nombre)
    ...
    Private Sub frmBodega_MuellesList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Muelles()
    End Sub
    ...
    Private Sub Nuevo_Muelle()
        ...
        Try
            ...
            With frmBodega_Muelles
                ...
                .Listar = AddressOf Listar_Muelles
                .MdiParent = MdiParent
                .Show()
                .Focus()
            End With
    ...
    Private Sub frmBodega_MuellesList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
