...
Public Class frmConsolidador_List


    Public gConsolidador As clsBeConsolidador

    'Public Property Propietario As New clsBePropietarios

    Public Property Modo As pModo
    Public Property OpcionesMenu As New clsBeOpcionesMenuRol
    Public pIdConsolidador As Integer
    ...
    Private Sub frmConsolidador_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Consolidador()
    End Sub

    Private Sub Listar_Consolidador()

        Try

            Dim lista As New DataTable

            lista = clsLnConsolidador.Get_All_Filtro_Seleccion(chkActivos.Checked)

            'If Modo = pModo.Seleccion Then
            '    lista = clsLnConsolidador.Get_All_Filtro_Seleccion(chkActivos.Checked)
            'Else
            '    lista = clsLnConsolidador.Get_All_Filtro(chkActivos.Checked)
            'End If
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Consolidadores"
    ...
    Private Sub Nuevo_Consolidador()

        Try

            Cierra_Instancia_Previa(frmConsolidador)

            With frmConsolidador
                .Modo = frmConsolidador.TipoTrans.Nuevo
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .MdiParent = MdiParent
                .InvokeListarClientes = AddressOf Listar_Consolidador
