...
Public Class frmTipoCuadrilla_List
    ...
    Private Sub ListarTipoCuadrilla()

        Try

            Dgrid.DataSource = clsLnCuadrilla_tipo.GetAll()
    ...
    Private Sub frmTipoCuadrilla_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ListarTipoCuadrilla()
    End Sub
    ...
    Private Sub Nuevo_Tipo_Cuadrilla()

        Try

            Cierra_Instancia_Previa(frmTipoCuadrilla)

            With frmTipoCuadrilla
                .Modo = frmTipoCuadrilla.TipoTrans.Nuevo
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .MdiParent = MdiParent
                .InvokeListarTipocuadrilla = AddressOf ListarTipoCuadrilla
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmTipoCuadrilla
                        .Modo = frmTipoCuadrilla.TipoTrans.Editar
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                        .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                        .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                        .pObjBEJ.IdTipoCuadrilla = Dr.Item("Código")
                        .InvokeListarTipocuadrilla = AddressOf ListarTipoCuadrilla
                        .MdiParent = MdiParent
                        .WindowState = FormWindowState.Normal
                        .Show()
    ...
    Private Sub frmTipoCuadrilla_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
