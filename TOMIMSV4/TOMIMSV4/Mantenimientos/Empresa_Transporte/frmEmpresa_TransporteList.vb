...
Public Class frmEmpresa_TransporteList
    ...
    Private Sub frmEmpresa_TransporteList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listar_EmpresaTransporte()
    End Sub
    ...
    Private Sub Nueva_EmpresaTransporte()

        Try

            Cierra_Instancia_Previa(frmEmpresa_Transporte)

            With frmEmpresa_Transporte
                .Modo = frmEmpresa_Transporte.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarEmpresaTransporte = AddressOf listar_EmpresaTransporte
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmEmpresa_Transporte
                        .Modo = frmEmpresa_Transporte.TipoTrans.Editar
                        .pObjBEJ.IdEmpresaTransporte = Dr.Item("Código")
                        .InvokeListarEmpresaTransporte = AddressOf listar_EmpresaTransporte
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = OpcionesMenu.Modificar
    ...
    Private Sub listar_EmpresaTransporte()
        Try

            Dgrid.DataSource = clsLnEmpresa_transporte.Listar(chkActivos.Checked, "")
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Empresas de Transporte"
    ...
    Private Sub frmEmpresa_TransporteList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
