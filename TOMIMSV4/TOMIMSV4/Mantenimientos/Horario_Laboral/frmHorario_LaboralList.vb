...
Public Class frmHorario_LaboralList
    ...
    Private Sub Listar_Horario_Laboral()

        Try

            Dgrid.DataSource = clsLnHorario_laboral_enc.Listar(chkActivos.Checked)
            ...
            If (GridView1.Columns.Count <> 0) Then
                ...
                Try
                    ...
                    GridView1.Columns("IdJornada").Visible = False
                    GridView1.Columns("IdTurno").Visible = False
    ...
    Private Sub frmHorario_LaboralList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Horario_Laboral()
    End Sub
    ...
    Private Sub Nuevo_Horario()

        Cierra_Instancia_Previa(frmHorario_Laboral)

        With frmHorario_Laboral
            .Modo = frmHorario_Laboral.TipoTrans.Nuevo
            .Listar = AddressOf Listar_Horario_Laboral
            .MdiParent = MdiParent
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    Cierra_Instancia_Previa(frmHorario_Laboral)
                    With frmHorario_Laboral
                        .Modo = frmHorario_Laboral.TipoTrans.Editar
                        .pObjEnc.IdHorarioLaboralEnc = Dr.Item("Código")
                        .Listar = AddressOf Listar_Horario_Laboral
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = OpcionesMenu.Modificar
    ...
    Private Sub frmHorario_LaboralList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
