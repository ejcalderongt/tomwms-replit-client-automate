...
Public Class frmServicio_List
    ...
    Private Sub listar_Servicios()

        Try

            Dgrid.DataSource = clsLnI_nav_servicio.GetAll()
    ...
    Private Sub frmServicio_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listar_Servicios()
    End Sub
    ...
    Private Sub mnuNuevo_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuNuevo.ItemClick
        ...
        Servicio.OpcionesMenu = OpcionesMenu
        Servicio.mnuGuardar.Enabled = OpcionesMenu.Modificar
        Servicio.mnuActualizar.Enabled = OpcionesMenu.Modificar
        Servicio.mnuEliminar.Enabled = OpcionesMenu.Eliminar
    ...
    Private Sub Dgrid_DoubleClick(sender As Object, e As EventArgs) Handles Dgrid.DoubleClick
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim BeINavServicio As New clsBeI_nav_servicio
                BeINavServicio = GridView1.GetFocusedRow
                Dim lSelectionIndex As Integer = GridView1.FocusedRowHandle

                If Modo = pModo.Lista Then
                    Dim Servicio As New frmRegServicio(frmServicioC.TipoTrans.Editar)
                    Servicio.ShowDialog()
                    Servicio.Dispose()
                    listar_Servicios()
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Try
            ...
            Dim reportHeader As String = vbNewLine & "Listado de Servicios"
