...
Public Class frmIndiceRotacion_List
    ...
    Private Sub ListarIndices()

        Try
            Dgrid.DataSource = clsLnIndice_rotacion.Listar(chkActivos.Checked)
    ...
    Private Sub Nuevo_Indice()
        ...
        Try
            ...
            Cierra_Instancia_Previa(frmIndiceRotacion)

            With frmIndiceRotacion
                .Modo = frmIndiceRotacion.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarIndices = AddressOf ListarIndices
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmIndiceRotacion
                        .Modo = frmIndiceRotacion.TipoTrans.Editar
                        .pObjBEJ.IdIndiceRotacion = Dr.Item("Código")
                        .InvokeListarIndices = AddressOf ListarIndices
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Indices rotacion"
    ...
    Private Sub frmIndiceRotacion_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
