...
Public Class frmJornada_LaboralList
    ...
    Private Sub Listar_Jornadas_Laborales()

        Try

            Dgrid.DataSource = clsLnJornada_laboral.Listar(chkActivos.Checked, "")
    ...
    Private Sub frmJornada_LaboralList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Jornadas_Laborales()
    End Sub
    ...
    Private Sub Nueva_Jornada_Laboral()

        Cierra_Instancia_Previa(frmJornada_Laboral)

        With frmJornada_Laboral
            .Modo = frmJornada_Laboral.TipoTrans.Nuevo
            .Listar = AddressOf Listar_Jornadas_Laborales
            .MdiParent = MdiParent
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    Cierra_Instancia_Previa(frmJornada_Laboral)
                    With frmJornada_Laboral
                        .Modo = frmJornada_Laboral.TipoTrans.Editar
                        .pObjBEJ.IdBodega = Dr.Item("IdBodega")
                        .pObjBEJ.IdJornada = Dr.Item("Código")
                        .Listar = AddressOf Listar_Jornadas_Laborales
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub frmJornada_LaboralList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
