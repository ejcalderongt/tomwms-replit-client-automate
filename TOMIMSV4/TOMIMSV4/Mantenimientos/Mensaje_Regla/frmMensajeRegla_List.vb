...
Public Class frmMensajeRegla_List
    ...
    Private Sub ListarMensajes()
        Try

            Dgrid.DataSource = Nothing
            Dim DT As New DataTable("MensajeRegla")
        ...
        End Try
    End Sub
    Private Sub frmMensajeRegla_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ListarMensajes()
    End Sub
    ...
    Private Sub Nuevo_MensajeRegla()

        Try

            Cierra_Instancia_Previa(frmMensajeRegla)

            With frmMensajeRegla
                .Modo = frmMensajeRegla.TipoTrans.Nuevo
                .MdiParent = MdiParent
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If GridView1.RowCount > 0 Then
                ...
                pObjMensaje = New clsBeMensaje_regla
                pObjMensaje = clsLnMensaje_regla.GetSingle(Dr.Item("Código"))
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmMensajeRegla
                        .Modo = frmMensajeRegla.TipoTrans.Editar
                        .pObjBEJ = pObjMensaje
                        .InvokeListarMensajes = AddressOf ListarMensajes
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Mensajes"
    ...
    Private Sub frmMensajeRegla_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
