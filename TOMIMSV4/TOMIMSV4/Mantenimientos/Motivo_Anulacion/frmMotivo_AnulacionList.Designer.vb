...
Partial Class frmMotivo_AnulacionList
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        If disposing Then
            If components IsNot Nothing Then
                components.Dispose()
            End If
            If BeMotivoAnulacionBodega IsNot Nothing Then
                BeMotivoAnulacionBodega.Dispose()
                BeMotivoAnulacionBodega = Nothing
            End If
        End If
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMotivo_AnulacionList))
        ...
        Me.RibbonPage1.Text = "Lista motivos de anulación"
        '
        'RibbonPageGroup1
        '
        ...
        Me.Name = "frmMotivo_AnulacionList"
