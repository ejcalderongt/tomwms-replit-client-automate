...
Public Class frmPais_List
    ...
    Private Sub listar_Paises()
        ...
        Try
            ...
            Dgrid.DataSource = clsLnPaises.Listar(chkActivos.Checked)
    ...
    Private Sub Nuevo_Pais()

        Try

            Cierra_Instancia_Previa(frmPais)

            With frmPais
                .Modo = frmPais.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarPais = AddressOf listar_Paises
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmPais
                        .Modo = frmPais.TipoTrans.Editar
                        .BePais.IdPais = Dr.Item("IdPais")
                        .InvokeListarPais = AddressOf listar_Paises
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
                        .mnuGuardar.Enabled = OpcionesMenu.Modificar
    ...
    Private Sub frmPais_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
