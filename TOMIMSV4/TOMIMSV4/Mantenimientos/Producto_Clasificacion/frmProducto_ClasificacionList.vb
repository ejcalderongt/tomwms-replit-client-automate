...
Public Class frmProducto_ClasificacionList

    Public pIdPropietario As Integer
    Public Property Modo As pModo
    Public Property OpcionesMenu As New clsBeOpcionesMenuRol
    Public pObjPC As clsBeProducto_clasificacion
    ...
    Private Sub frmProducto_ClasificacionList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listarProductoClasificacion()
    End Sub

    Private Sub listarProductoClasificacion()

        Try

            Dgrid.DataSource = Nothing

            Dim lista As New List(Of clsBeProducto_clasificacion)
            lista = clsLnproducto_clasificacion.Get_All_Filtro(chkActivos.Checked, pIdPropietario).ToList()

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("Clasificacion")
                ...
                For Each Obj As clsBeProducto_clasificacion In lista
                    DT.Rows.Add(Obj.IdClasificacion, Obj.Propietario.IdPropietario, Obj.Propietario.Nombre_comercial, Obj.Nombre, Obj.Activo, Obj.User_agr, Obj.Fec_agr, Obj.User_mod, Obj.Fec_mod)
                Next
                ...
                If (GridView1.Columns.Count <> 0) Then
                    Try
                        ...
                        GridView1.Columns("IdClasificacion").Caption = "Código"
    ...
    Private Sub Nueva_ClasificacionProducto()

        Try

            Cierra_Instancia_Previa(frmProducto_Clasificacion)

            With frmProducto_Clasificacion
                .Modo = frmProducto_Clasificacion.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarProductoClasificacion = AddressOf listarProductoClasificacion
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Obj = clsLnProducto_clasificacion.GetSingle(Dr.Item("IdClasificacion"))

                If Me.Modo = frmProducto_ClasificacionList.pModo.Lista Then

                    Cierra_Instancia_Previa(frmProducto_Clasificacion)

                    With frmProducto_Clasificacion
                        .Modo = frmProducto_Clasificacion.TipoTrans.Editar
                        .pBeProductoClasificacion = Obj
                        .InvokeListarProductoClasificacion = AddressOf listarProductoClasificacion
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
                        .mnuGuardar.Enabled = OpcionesMenu.Modificar
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Productos Clasificación"
    ...
    Private Sub cmdImportarExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdImportarExcel.ItemClick
        ...
        Carga.pNombreMantenimiento = "Producto Clasificación"
        Carga.pTipoMantenimiento = "ProductoClasificacion"
        Carga.Listar = New frmCargaExcel.Operar(AddressOf listarProductoClasificacion)
        Carga.ShowDialog()
        Carga.Dispose()
    ...
    Private Sub frmProducto_ClasificacionList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
