...
Public Class frmProducto_ColorList
    ...
    Private Sub Cargar_Datos()
        ...
        Try
            ...
            table = clsLnColor.Listar(chkActivos.Checked)
    ...
    Private Sub frmProducto_ColorList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            Cargar_Datos()
        Catch ex As Exception
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Colores"
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim objColor As New clsBeColor
                objColor = clsLnColor.GetSingle_By_IdColor(Dr.Item("IdColor"))

                Cierra_Instancia_Previa(frmProducto_Color)

                With frmProducto_Color
                    .Modo = frmProducto_Color.TipoTrans.Editar
                    .objColor = objColor
                    .InvokeListarColores = AddressOf Cargar_Datos
                    .MdiParent = MdiParent
    ...
    Private Sub Nuevo_Color()
        Try
            Cierra_Instancia_Previa(frmProducto_Color)

            With frmProducto_Color
                .Modo = frmProducto_Color.TipoTrans.Nuevo
                .InvokeListarColores = AddressOf Cargar_Datos
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .cmdGuardar.Enabled = OpcionesMenu.Modificar
