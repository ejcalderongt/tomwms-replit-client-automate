...
Public Class frmProducto_MarcaList

    Public pIdPropietario As Integer
    Public pObjM As clsBeProducto_marca
    ...
    Enum pModo
        ...
        Seleccion = 2
    End Enum
    Private Sub frmProducto_MarcaList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listarProductoMarca()
    End Sub

    Private Sub listarProductoMarca()
        Try

            Dgrid.DataSource = Nothing

            Dim lista As New List(Of clsBeProducto_marca)
            lista = clsLnProducto_Marca.GetAllFiltro(chkActivos.Checked, pIdPropietario).ToList()

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("Marca")
                ...
                For Each Obj As clsBeProducto_marca In lista
                    DT.Rows.Add(Obj.IdMarca, Obj.Propietario.IdPropietario, Obj.Propietario.Nombre_comercial, Obj.Nombre, Obj.Activo, Obj.User_agr, Obj.Fec_agr, Obj.User_mod, Obj.Fec_mod)
                Next

                Dgrid.DataSource = DT
                If (GridView1.Columns.Count <> 0) Then
                    Try
                        GridView1.Columns("IdMarca").Caption = "Código"
    ...
    Private Sub Nuevo_ProductoMarca()

        Try

            Cierra_Instancia_Previa(frmProducto_Marca)

            With frmProducto_Marca
                .Modo = frmProducto_Marca.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarProductoMarca = AddressOf listarProductoMarca
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Obj = clsLnProducto_marca.GetSingle(Dr.Item("IdMarca"))
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmProducto_Marca
                        .Modo = frmProducto_Marca.TipoTrans.Editar
                        .pObjMarca = Obj
                        .InvokeListarProductoMarca = AddressOf listarProductoMarca
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Marcas"
    ...
    Private Sub cmdImportarExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdImportarExcel.ItemClick
        ...
        Carga.pNombreMantenimiento = "Producto Marca"
        Carga.pTipoMantenimiento = "ProductoMarca"
        Carga.Listar = New frmCargaExcel.Operar(AddressOf listarProductoMarca)
        Carga.ShowDialog()
        Carga.Dispose()
    ...
    Private Sub frmProducto_MarcaList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
