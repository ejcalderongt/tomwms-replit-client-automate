...
Public Class frmProducto_Parametro_AList


    Public pObjPF As clsBeProducto_parametro_a
    ...
    Private Sub frmProducto_Parametro_AList_Load(sender As Object, e As EventArgs) Handles Me.Load
        listarParametrosA()
    End Sub

    Private Sub listarParametrosA()
        Try

            Dim lista As List(Of clsBeProducto_parametro_a) = clsLnProducto_parametro_a.Get_All_Filtro(chkActivos.Checked)

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("ParametroA")
                DT.Columns.Add("IdProductoParametroA", GetType(Integer))
                ...
                For Each Obj As clsBeProducto_parametro_a In lista
                    DT.Rows.Add(Obj.IdProductoParametroA, Obj.Codigo, Obj.Nombre, Obj.Fec_agr, Obj.User_agr, Obj.User_mod, Obj.Fec_mod, Obj.Activo)
                Next
                ...
                If (GridView1.Columns.Count <> 0) Then
                    ...
                    Try
                        ...
                        GridView1.Columns("IdProductoParametroA").Caption = "Id Parametro"
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Parámetros A"
    ...
    Private Sub mnuImportar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuImportar.ItemClick
        ...
        Carga.Listar = New frmCargaExcel.Operar(AddressOf listarParametrosA)
        Carga.ShowDialog()
        Carga.Dispose()
    ...
    Private Sub Nuevo_ParametroA()

        Try

            Cierra_Instancia_Previa(frmProducto_Parametro_A)

            With frmProducto_Parametro_A
                .Modo = frmProducto_Parametro_A.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarProductoParametroA = AddressOf listarParametrosA
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim Obj As New clsBeProducto_parametro_a
                Obj = clsLnProducto_parametro_a.GetSingle(Dr.Item("IdProductoParametroA"))
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmProducto_Parametro_A
                        .Modo = frmProducto_Parametro_A.TipoTrans.Editar
                        .pObjPF = Obj
                        .InvokeListarProductoParametroA = AddressOf listarParametrosA
                        .MdiParent = MdiParent
                        .WindowState = FormWindowState.Normal
