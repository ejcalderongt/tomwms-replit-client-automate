...
Public Class frmProducto_TallaList
    ...
    Private Sub Cargar_Lista()
        Try
            ...
            table = clsLnTalla.Listar(chkActivos.Checked)
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Tallas"
    ...
    Private Sub Nueva_Talla()
        Try
            Cierra_Instancia_Previa(frmProducto_Talla)

            With frmProducto_Talla
                .Modo = frmProducto_Talla.TipoTrans.Nuevo
                .InvokeListarTallas = AddressOf Cargar_Lista
                .MdiParent = MdiParent
    ...
    Private Sub frmProducto_TallaList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            Cargar_Lista()
        Catch ex As Exception
            XtraMessageBox.Show(ex.Message, Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim ObjTalla As New clsBeTalla
                ObjTalla = clsLnTalla.GetSingle_By_IdTalla(Dr.Item("IdTalla"))

                'If Me.Modo = frmProducto_TallaList.pModo.Lista Then
                ...
                With frmProducto_Talla
                    .Modo = frmProducto_Talla.TipoTrans.Editar
                    .InvokeListarTallas = AddressOf Cargar_Lista
                    .objTalla = ObjTalla
                    .MdiParent = MdiParent
                    .OpcionesMenu = OpcionesMenu()
