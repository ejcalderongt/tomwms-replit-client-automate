...
Public Class frmProducto_TipoList

    Public pIdPropietario As Integer
    Public pObjTP As clsBeProducto_tipo
    ...
    Private Sub listarProductoTipo()
        Try

            Dgrid.DataSource = Nothing

            Dim lista As New List(Of clsBeProducto_tipo)
            lista = clsLnProducto_tipo.GetAllFiltro(chkActivos.Checked, pIdPropietario).ToList()

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("Tipo")
                DT.Columns.Add("IdTipoProducto", GetType(Integer))
                ...
                For Each Obj As clsBeProducto_tipo In lista
                    DT.Rows.Add(Obj.IdTipoProducto, Obj.Propietario.IdPropietario, Obj.Propietario.Nombre_comercial, Obj.NombreTipoProducto, Obj.Activo, Obj.User_agr, Obj.Fec_agr, Obj.User_mod, Obj.Fec_mod)
                Next
                ...
                If (GridView1.Columns.Count <> 0) Then
                    Try
                        ...
                        GridView1.Columns("IdTipoProducto").Caption = "Código"
    ...
    Private Sub Nuevo_ProductoTipo()

        Try

            Cierra_Instancia_Previa(frmProducto_Tipo)

            With frmProducto_Tipo
                .Modo = frmProducto_Tipo.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = OpcionesMenu.Modificar
                .mnuActualizar.Enabled = OpcionesMenu.Modificar
                .mnuEliminar.Enabled = OpcionesMenu.Eliminar
                .InvokeListarProductoTipo = AddressOf listarProductoTipo
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Obj = clsLnProducto_tipo.GetSingle(Dr.Item("IdTipoProducto"))
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmProducto_Tipo
                        .Modo = frmProducto_Tipo.TipoTrans.Editar
                        .pObjPT = Obj
                        .InvokeListarProductoTipo = AddressOf listarProductoTipo
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Tipos"
    ...
    Private Sub frmProducto_TipoList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
