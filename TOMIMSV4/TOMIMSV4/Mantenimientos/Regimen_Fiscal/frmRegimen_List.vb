...
Public Class frmRegimenFiscal_List
    ...
    Private Sub frmRegimenFiscal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_RegimenFiscales()
    End Sub

    Private Sub Listar_RegimenFiscales()

        Try

            Dgrid.DataSource = Nothing

            Dim lista As New List(Of clsBeRegimen_fiscal)

            lista = clsLnRegimen_fiscal.Get_All()

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("RegimenFiscal")
                DT.Columns.Add("IdRegimen", GetType(Integer))
                DT.Columns.Add("Código", GetType(String))
                DT.Columns.Add("Nombre", GetType(String))
                DT.Columns.Add("Días_Vencimiento", GetType(Double))

                Parallel.ForEach(lista, Sub(ByVal Obj)
                                            SyncLock DT
                                                DT.Rows.Add(Obj.IdRegimen, Obj.Codigo_regimen, Obj.Descripcion, Obj.Dias_vencimiento)
                                            End SyncLock
                                        End Sub)
                ...
                If (GridView1.Columns.Count <> 0) Then
                    ...
                    Try
                        'GridView1.Columns("IdRegimen").Caption = "Código"
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            Cierra_Instancia_Previa(frmRegimenFiscal)

            With frmRegimenFiscal
                .Modo = frmRegimenFiscal.TipoTrans.Nuevo
                .Listar = AddressOf Listar_RegimenFiscales
                .MdiParent = MdiParent
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                gBeRegimenFiscal.IdRegimen = Dr.Item("IdRegimen")
                clsLnRegimen_fiscal.GetSingle(gBeRegimenFiscal)
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmRegimenFiscal
                        .Modo = frmRegimenFiscal.TipoTrans.Editar
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                        .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                        .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                        .gBeRegimenFiscal = gBeRegimenFiscal
                        .Listar = AddressOf Listar_RegimenFiscales
                        .Show()
                        .Focus()
                    End With
    ...
    Private Sub frmRegimenFiscal_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
