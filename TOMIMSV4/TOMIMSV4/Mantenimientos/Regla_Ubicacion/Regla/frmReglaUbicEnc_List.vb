...
Public Class frmReglaUbicEnc_List

    Public selid As Integer = 0
    Public selnom As String = ""
    ...
    Private Sub ListarReglas()
        ...
        Try
            ...
            Dgrid.DataSource = clsLnRegla_ubic_enc.Listar(AP.IdBodega, AP.IdEmpresa, chkActivos.Checked)
    ...
    Private Sub frmTipoTarima_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If (Modo = pModo.Lista) Then mnuEdit.Visibility = DevExpress.XtraBars.BarItemVisibility.Never Else mnuEdit.Visibility = DevExpress.XtraBars.BarItemVisibility.Always
        selid = 0
    End Sub
    ...
    Private Sub Nueva_Regla()

        Try

            Cierra_Instancia_Previa(frmReglaUbic)

            With frmReglaUbic
                .Modo = frmReglaUbic.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarReglas = AddressOf ListarReglas
    ...
    Private Sub EditItem()
        ...
        Try
            ...
            With frmReglaUbic
                .Modo = frmReglaUbic.TipoTrans.Editar
                .pBeReglaUbicEnc.IdReglaUbicacionEnc = Dr.Item("Código")
                .InvokeListarReglas = AddressOf ListarReglas
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub Dgrid_DoubleClick(sender As Object, e As EventArgs) Handles Dgrid.DoubleClick
        ...
        Try
            ...
            Try
                ...
                SplashScreenManager.Default.SetWaitFormCaption("Cargando Regla...")
            Catch ex As Exception
            End Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                ElseIf Modo = pModo.Seleccion Then
                    ...
                    selid = Dr.Item("Código")
                    selnom = clsLnRegla_ubic_enc.GetNombre(Dr.Item("Código"))
                    Hide()
    ...
    Private Sub Dgrid_KeyDown(sender As Object, e As KeyEventArgs) Handles Dgrid.KeyDown
        If e.KeyCode = Keys.Enter Then EditItem()
    End Sub

    Private Sub frmReglaUbicEnc_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
