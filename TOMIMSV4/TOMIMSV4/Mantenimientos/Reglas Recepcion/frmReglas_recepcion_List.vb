...
Public Class frmReglas_recepcion_List

    Public Property Modo As pModo
    Public Property OpcionesMenu As New clsBeOpcionesMenuRol
    Public pObjRegla As clsBeReglas_recepcion
    ...
    Private Sub mnuActualizar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuActualizar.ItemClick
        listar_Reglas_Recepcion()
    End Sub

    Private Sub frmReglas_recepcion_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listar_Reglas_Recepcion()
    End Sub
    ...
    Private Sub Nueva_ReglaRecepcion()

        Try

            Cierra_Instancia_Previa(frmRegla_Recepcion)

            With frmRegla_Recepcion
                .Modo = frmRegla_Recepcion.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu()
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarReglasRecepcion = AddressOf listar_Reglas_Recepcion
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim Dr As clsBeReglas_recepcion
                Dr = GridView1.GetFocusedRow

                'pObjRegla = New clsBeReglas_recepcion
                'pObjRegla = clsLnReglas_recepcion.GetSingle(Dr)
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmRegla_Recepcion
                        .Modo = frmRegla_Recepcion.TipoTrans.Editar
                        .pObjRegla.IdReglaRecepcion = Dr.IdReglaRecepcion
                        .InvokeListarReglasRecepcion = AddressOf listar_Reglas_Recepcion
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu()
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub frmReglas_recepcion_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
