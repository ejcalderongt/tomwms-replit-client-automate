...
Public Class frmListaRoadRuta
    Public gBeRoadRuta As New clsBeRoad_ruta
    Dim Lista As New List(Of clsBeRoad_ruta)
    ...
    Private Sub Nuevo_Road()

        Try

            Cierra_Instancia_Previa(frmRoadxRuta)

            With frmRoadxRuta
                .Modo = frmRoadxRuta.TipoTrans.Nuevo
                .MdiParent = Me.MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarRutas = AddressOf Listar_Rutas
    ...
    Private Sub Listar_Rutas()

        Try

            Lista = clsLnRoad_ruta.GetAllFiltro(chkActivos.Checked).ToList

            If Lista IsNot Nothing AndAlso Lista.Count > 0 Then

                Dim DT As New DataTable("road_ruta")
                DT.Columns.Add("ID", GetType(Integer))
                DT.Columns.Add("Código", GetType(String))
                DT.Columns.Add("Nombre", GetType(String))

                For Each Obj As clsBeRoad_ruta In Lista
                    DT.Rows.Add(Obj.IdRuta, Obj.CODIGO, Obj.NOMBRE)
                Next
        ...
        Try
            ...
            If GridView1.RowCount > 0 Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmRoadxRuta
                        .Modo = frmRoadxRuta.TipoTrans.Editar
                        .gBeRoadRuta = clsLnRoad_ruta.GetSingle(Dr.Item("ID"))
                        .InvokeListarRutas = AddressOf Listar_Rutas
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                ...
                ElseIf Modo = pModo.Seleccion Then
                    ...
                    gBeRoadRuta.IdRuta = CInt(Dr.Item("ID"))
                    gBeRoadRuta.NOMBRE = Dr.Item("Nombre")
                    Hide()
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Rutas en ROAD"
    ...
    Private Sub frmListaRoadRuta_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
