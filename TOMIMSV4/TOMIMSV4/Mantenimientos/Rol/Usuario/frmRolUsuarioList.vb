...
Public Class frmRolUsuarioList

    Public Property Modo As pModo
    Public Property OpcionesMenu As New clsBeOpcionesMenuRol
    Public ObjetoRolUsuario As New clsBeRol
    ...
    Private Sub cargarListadeRoles()
        ...
        Try
            ...
            Dim lista As New List(Of clsBeRol)

            lista = clsLnRol.ListarxFiltro("", AP.IdEmpresa)

            If lista IsNot Nothing AndAlso lista.Count > 0 Then

                Dim DT As New DataTable("RolUsuario")
                DT.Columns.Add("ID", GetType(String))
                DT.Columns.Add("NOMBRE", GetType(String))

                For Each Obj As clsBeRol In lista
                    DT.Rows.Add(Obj.IdRol, Obj.Nombre)
                Next
    ...
    Private Sub Nuevo_RolUsuario()

        Try

            With frmRolUsuario
                .Modo = frmRolUsuario.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarRolesUsuario = AddressOf cargarListadeRoles
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = String.Format("{0}Listado de Roles de Usuario {1}", vbNewLine, AP.NomEmpresa)
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmRolUsuario
                        .Modo = frmRolUsuario.TipoTrans.Editar
                        .BeRol.IdRol = Dr.Item("ID")
                        .InvokeListarRolesUsuario = AddressOf cargarListadeRoles
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                ...
                ElseIf Modo = pModo.Seleccion Then
                    ObjetoRolUsuario.IdRol = Dr.Item("ID")
                    ObjetoRolUsuario.Nombre = Dr.Item("NOMBRE")
                    Hide()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub frmRolUsuarioList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
