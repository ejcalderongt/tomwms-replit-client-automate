...
Public Class frmSeriesDoc_List
    ...
    Private Sub Listar_Series()
        ...
        Try
            ...
            DT = clsLnTrans_series_doc.GetAllFiltro(chkActivos.Checked)
            ...
            If DT IsNot Nothing AndAlso DT.Rows.Count > 0 Then
                ...
                If (GridView1.Columns.Count <> 0) Then
                    ...
                    Try
                        GridView1.Columns("IdTransSerieDoc").Caption = "Código"
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            Cierra_Instancia_Previa(frmSeriesDoc)

            With frmSeriesDoc
                .Modo = frmSeriesDoc.TipoTrans.Nuevo
                .Listar = AddressOf Listar_Series
                .MdiParent = MdiParent
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            Dim BeSeriesDoc As New clsBeTrans_series_doc

            If (GridView1.RowCount > 0) Then

                Dim Dr As DataRowView = GridView1.GetFocusedRow

                BeSeriesDoc.IdTransSerieDoc = Dr.Item("IdTransSerieDoc")

                BeSeriesDoc = clsLnTrans_series_doc.GetSingle(BeSeriesDoc)
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmSeriesDoc
                        .Modo = frmSeriesDoc.TipoTrans.Editar
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                        .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                        .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                        .BeTransSeriesDoc = BeSeriesDoc
                        .Listar = AddressOf Listar_Series
                        .Show()
                        .Focus()
                    End With
    ...
    Private Sub frmSeriesDoc_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
