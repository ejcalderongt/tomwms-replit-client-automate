...
Public Class frmTarima_Lista
    ...
    Private Sub ListarTarimas()

        Try

            Dgrid.DataSource = clsLnTarimas.Listar(chkActivos.Checked)
    ...
    Private Sub frmTarima_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ListarTarimas()
    End Sub
    ...
    Private Sub Nueva_Tarima()

        Try

            Cierra_Instancia_Previa(frmTarima)

            With frmTarima
                .Modo = frmTarima.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarTarimas = AddressOf ListarTarimas
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmTarima
                        .Modo = frmTarima.TipoTrans.Editar
                        .pObjBEJ.IdTarima = Dr.Item("Correlativo")
                        .InvokeListarTarimas = AddressOf ListarTarimas
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Tarimas"
    ...
    Private Sub cmdImportarExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdImportarExcel.ItemClick
        ...
        Carga.pNombreMantenimiento = "Tarimas"
        Carga.pTipoMantenimiento = "Tarima"
        Carga.Listar = New frmCargaExcel.Operar(AddressOf ListarTarimas)
        Carga.ShowDialog()
        Carga.Dispose()
    ...
    Private Sub frmTarima_Lista_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
