...
Public Class frmTipoContenedor_List
    ...
    Private Sub ListarTipoContenedor()
        Try
            Dgrid.DataSource = clsLnTipo_contenedor.Listar(chkActivos.Checked)
        ...
        End Try
    End Sub
    Private Sub frmTipoContenedor_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ListarTipoContenedor()
    End Sub
    ...
    Private Sub Nuevo_Tipo_Contenedor()

        Try

            Cierra_Instancia_Previa(frmTipoContenedor)

            With frmTipoContenedor
                .Modo = frmTipoContenedor.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarTipoContenedor = AddressOf ListarTipoContenedor
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmTipoContenedor
                        .Modo = frmTipoContenedor.TipoTrans.Editar
                        .pObjBEJ.IdTipoContenedor = Dr.Item("Código")
                        .InvokeListarTipoContenedor = AddressOf ListarTipoContenedor
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Tipos de Contenedores"
    ...
    Private Sub frmTipoContenedor_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
