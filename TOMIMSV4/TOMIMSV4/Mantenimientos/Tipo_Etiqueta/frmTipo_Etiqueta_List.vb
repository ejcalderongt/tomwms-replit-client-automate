...
Public Class frmTipo_Etiqueta_List
    ...
    Private Sub Nuevo_Indice()

        Try

            Cierra_Instancia_Previa(frmTipo_Etiqueta)

            With frmTipo_Etiqueta
                .Modo = frmTipo_Etiqueta.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarEtiquetas = AddressOf ListarEtiquetas
    ...
    Private Sub ListarEtiquetas()
        Try
            Dgrid.DataSource = clsLnTipo_etiqueta.Listar(chkActivos.Checked)
    ...
    Private Sub frmTipo_Etiqueta_List_Load(sender As Object, e As EventArgs) Handles Me.Load
        ListarEtiquetas()
    End Sub
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmTipo_Etiqueta
                        .Modo = frmTipo_Etiqueta.TipoTrans.Editar
                        .ObjTE.IdTipoEtiqueta = Dr.Item("Código")
                        .InvokeListarEtiquetas = AddressOf ListarEtiquetas
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Tipos de Etiqueta"
    ...
    Private Sub frmTipo_Etiqueta_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
