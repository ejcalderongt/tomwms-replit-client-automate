...
Public Class frmTipoDocumentoIngresoList
    ...
    Private Sub frmTipoDocumentoIngresoList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Tipos_Documento_Ingreso()
    End Sub

    Private Sub Listar_Tipos_Documento_Ingreso()
    ...
    Private Sub Nuevo_ProductoTipo()
        ...
        Try
            ...
            With frmTipoDocumentoIngreso
                ...
                .InvokeListarProductoTipo = AddressOf Listar_Tipos_Documento_Ingreso
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim vIdTipoIngreso As Integer = Dr.Item("IdTipoIngresoOC")

                Dim Obj As New clsBeTrans_oc_ti
                Obj = clsLnTrans_oc_ti.GetSingle(vIdTipoIngreso)
    ...
    Private Sub frmTipoDocumentoIngresoList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
