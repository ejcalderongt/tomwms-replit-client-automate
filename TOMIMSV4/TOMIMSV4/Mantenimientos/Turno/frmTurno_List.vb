...
Public Class frmTurno_List
    ...
    Private Sub Listar_Turnos()
        ...
        Try
            ...
            Dgrid.DataSource = clsLnTurno.Listar(chkActivos.Checked, "")
    ...
    Private Sub frmTurno_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Turnos()
    End Sub
    ...
    Private Sub Nuevo_Turno()
        ...
        Try
            ...
            Cierra_Instancia_Previa(frmTurno)

            With frmTurno
                .Modo = frmTurno.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .Listar = AddressOf Listar_Turnos
                .Show()
                .Focus()
            End With
        ...
        Try
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmTurno
                        .Modo = frmTurno.TipoTrans.Editar
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
                        .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                        .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                        .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                        .pObjBET.IdTurno = Dr.Item("Código")
                        .Listar = AddressOf Listar_Turnos
                        .Show()
                        .Focus()
                    End With
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Turnos"
    ...
    Private Sub frmTurno_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
