...
Public Class frmUnidad_MedidaList

    Public pIdPropietario As Integer
    Public pObjUM As clsBeUnidad_medida
    ...
    Private Sub listarUM()
        ...
        Try
            ...
            'Dim lista As New List(Of clsBeUnidad_medida)
            Dim lista As New DataTable
            lista = clsLnUnidad_medida.Get_All_Filtro_DT(chkActivos.Checked, pIdPropietario)
    ...
    Private Sub Nueva_UM()

        Try

            Cierra_Instancia_Previa(frmUnidad_Medida)

            With frmUnidad_Medida
                .Modo = frmUnidad_Medida.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .OpcionesMenu = OpcionesMenu
                .mnuGuardar.Enabled = .OpcionesMenu.Modificar
                .mnuActualizar.Enabled = .OpcionesMenu.Modificar
                .mnuEliminar.Enabled = .OpcionesMenu.Eliminar
                .InvokeListarUM = AddressOf listarUM
    ...
    Private Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                Dim IdUnidadMedida As Integer = Integer.Parse(Dr.Item("Correlativo"))

                Obj = clsLnUnidad_medida.GetSingle(IdUnidadMedida)
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmUnidad_Medida
                        .Modo = frmUnidad_Medida.TipoTrans.Editar
                        .pObjUM = Obj
                        .InvokeListarUM = AddressOf listarUM
                        .MdiParent = MdiParent
                        .OpcionesMenu = OpcionesMenu
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Listado de Unidad de Medidas"
    ...
    Private Sub cmdImportarExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdImportarExcel.ItemClick
        Dim Carga As New frmCargaExcel With {
            .pNombreMantenimiento = "Unidad de Medida",
            .pTipoMantenimiento = "UnidadMedida",
            .Listar = New frmCargaExcel.Operar(AddressOf listarUM)
        }
        Carga.ShowDialog()
        Carga.Dispose()
    ...
    Private Sub frmUnidad_MedidaList_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then Close()
    End Sub

    Private Sub mnuPlantilla_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuPlantilla.ItemClick

        Try

            Process.Start("Excel", CurDir() & "\Mantenimientos\plantillas\WMS_plantilla_Importacion_umbas.xlsx")
