...
Partial Public Class xtrbc
    ...
    Private Sub InitializeComponent()
        ...
        'ObjectDataSource1
        '
        Me.ObjectDataSource1.DataMember = "Producto"
        Me.ObjectDataSource1.DataSource = GetType(clsBeTrans_oc_det)
        ...
        Me.Margins = New DevExpress.Drawing.DXMargins(100, 100, 0, 47)
