...
Partial Public Class rptDespacho
    ...
    "odigo_Cliente]  IdPedidoEnc [IdPedidoEnc]"
        ...
        Me.XrLabel43.Padding = New DevExpress.XtraPrinting.PaddingInfo(CInt(2.0!), CInt(2.0!), CInt(0!), CInt(0!), CSng(100.0!))
        ...
        Me.XrLabel42.Padding = New DevExpress.XtraPrinting.PaddingInfo(CInt(2.0!), CInt(2.0!), CInt(0!), CInt(0!), CSng(100.0!))
