...
Public Class frmLogMI3
    ...
    Private pListLogs As New List(Of clsBeI_nav_ejecucion_det_error)
    Private DT As New DataTable("LogsMI3")
    ...
    Private Sub SetDatataTable()
        ...
        DT.Columns.Add("idejecuciondet", GetType(Integer))
    ...
    Private Sub Cargar()
        ...
        Try
            ...
            pListLogs = clsLnI_nav_ejecucion_det_error.Get_All_By_Rango_Fecha(dtpFechaDel.Value, dtpFechaAl.Value)

            If pListLogs.Count > 0 Then

                grdCardex.DataSource = Nothing
                DT.Clear()

                For Each Obj As clsBeI_nav_ejecucion_det_error In pListLogs

                    DT.Rows.Add(Obj.Idejecuciondet,
                                 Obj.vError,
                                 Obj.Referencia,
                                 Obj.Fecha)
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Log de interface MI3"
