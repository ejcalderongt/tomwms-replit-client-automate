...
Public Class rptOCCostoArancel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TOMWMS.rptOCCostoArancel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOCCostoArancel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOCCostoArancel = New rptOCCostoArancel()
        rpt.Site = Me.Site
        Return rpt
    End Function
