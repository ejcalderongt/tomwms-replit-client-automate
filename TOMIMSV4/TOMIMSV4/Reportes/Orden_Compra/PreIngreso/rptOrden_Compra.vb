...
Public Class rptOrden_Compra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TOMWMS.rptOrden_Compra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrden_Compra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrden_Compra = New rptOrden_Compra()
        rpt.Site = Me.Site
        Return rpt
    End Function
