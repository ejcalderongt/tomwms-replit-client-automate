...
Partial Public Class rptPackingTallaColor
    ...
    Private Sub InitializeComponent()
        ...
        Me.DetailCaption1.Padding = New DevExpress.XtraPrinting.PaddingInfo(CInt(6.0), CInt(6.0), CInt(0), CInt(0), CSng(100.0))
        ...
        Me.DetailData1.Padding = New DevExpress.XtraPrinting.PaddingInfo(CInt(6.0), CInt(6.0), CInt(0), CInt(0), CSng(100.0))
