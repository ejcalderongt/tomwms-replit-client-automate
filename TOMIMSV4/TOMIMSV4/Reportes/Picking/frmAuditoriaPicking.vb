...
Public Class frmAuditoriaPicking
    ...
    Private Sub Cargar_Datos()
        ...
        Try
            ...
            DT = clsLnTrans_picking_ubic.Get_Progreso_Picking(dtpFechaDesde.Value, dtpfechaHasta.Value)
            ...
            If Not DT Is Nothing Then
                ...
                If DT.Rows.Count > 0 Then
                    ...
                    GridView1.Columns("Fecha_Agregado").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
                    GridView1.Columns("Fecha_Agregado").DisplayFormat.FormatString = "G"

                    GridView1.Columns("Fecha_Picking").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
                    GridView1.Columns("Fecha_Picking").DisplayFormat.FormatString = "G"
            ...
            DT1 = clsLnTrans_picking_ubic.Get_Reporte_Resumen_Pickings_By_Fechas(dtpFechaDesde.Value, dtpfechaHasta.Value)
            ...
            If DT1.Rows.Count > 0 Then
                ...
                GridView2.Columns("Horas_Picking_Total").SummaryItem.SummaryType = SummaryItemType.Sum
                GridView2.Columns("Horas_Picking_Total").SummaryItem.DisplayFormat = "{0:n2}"
                GridView2.Columns("Horas_Picking_Total").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                GridView2.Columns("Horas_Picking_Total").DisplayFormat.FormatString = "{0:n2}"

                GridView2.Columns("Cantidad_Pickings").SummaryItem.SummaryType = SummaryItemType.Sum
                GridView2.Columns("Cantidad_Pickings").SummaryItem.DisplayFormat = "{0:n2}"
                GridView2.Columns("Cantidad_Pickings").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                GridView2.Columns("Cantidad_Pickings").DisplayFormat.FormatString = "{0:n2}"

                Dim item As GridGroupSummaryItem = New GridGroupSummaryItem() _
                        With {.FieldName = "Horas_Picking_Total", .SummaryType = SummaryItemType.Sum,
                        .DisplayFormat = "{0:n2}", .ShowInGroupColumnFooter = GridView1.Columns("Horas_Picking_Total")}
                GridView1.GroupSummary.Add(item)

                Dim item1 As GridGroupSummaryItem = New GridGroupSummaryItem() _
                        With {.FieldName = "Cantidad_Pickings", .SummaryType = SummaryItemType.Sum,
                        .DisplayFormat = "{0:n2}", .ShowInGroupColumnFooter = GridView1.Columns("Cantidad_Pickings")}
                GridView1.GroupSummary.Add(item1)

                GridView2.BestFitColumns()

                ConfigurePickingChart(ChartControl1, DT1)

            End If

            Dim dt2 As New DataTable
            dt2 = clsLnTrans_despacho_det.Get_Reporte_Tiempos_Despacho_By_Fechas(dtpFechaDesde.Value, dtpfechaHasta.Value)
            dgridTiemposPedido.DataSource = dt2

            If GridView3.Columns.Count > 0 Then

                GridView3.Columns("Fecha_Pedido").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
                GridView3.Columns("Fecha_Pedido").DisplayFormat.FormatString = "G"

                GridView3.Columns("Fecha_Despacho").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
                GridView3.Columns("Fecha_Despacho").DisplayFormat.FormatString = "G"
    ...
    Private Sub cmdExToExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdExToExcel.ItemClick
        Exportar_Grid_A_Excel(dgAuditoriaPicking, "ProgresoPicking.xlsx")
    End Sub
    ...
    Private Sub frmProgresoPicking_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        Try
            ...
            vNombreArchivoLayOutGrid = dgAuditoriaPicking.Name & ".xml"
    ...
    Private Sub ConfigurePickingChart(chartControl As ChartControl, dataTable As DataTable)
        Try
            chartControl.Series.Clear()
            chartControl.Titles.Clear()

            ' Crear la serie de barras para Horas de Picking
            Dim series1 As New DevExpress.XtraCharts.Series("Horas de Picking", ViewType.Bar)
            series1.ArgumentDataMember = "Fecha"
            series1.ValueDataMembers.AddRange("Horas_Picking_Total")
            series1.DataSource = dataTable

            ' Crear la serie de línea para Cantidad de Pickings
            Dim series2 As New DevExpress.XtraCharts.Series("Cantidad de Pickings", ViewType.Line)
            series2.ArgumentDataMember = "Fecha"
            series2.ValueDataMembers.AddRange("Cantidad_Pickings")
            ...
            diagram.AxisX.Title.Text = "Fecha"
            diagram.AxisX.Title.Visibility = DevExpress.Utils.DefaultBoolean.True
            diagram.AxisY.Title.Text = "Horas de Picking / Cantidad"
            diagram.AxisY.Title.Visibility = DevExpress.Utils.DefaultBoolean.True

            ' Configuración del título del gráfico
            Dim title As New ChartTitle()
            title.Text = "Análisis de Picking por Fecha"
