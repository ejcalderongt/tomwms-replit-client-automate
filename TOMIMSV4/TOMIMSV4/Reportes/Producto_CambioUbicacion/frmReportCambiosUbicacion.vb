...
Public Class frmReportCambiosUbicacion
    ...
    Private Sub Cargar()
        ...
        Try
            ...
            DT = clsLnTrans_movimientos.Get_All_Movimientos_Cambio_Ubic_DT(dtpFechaDel.Value,
                                                                             dtpFechaAl.Value,
                                                                             IdProductoBodega,
                                                                             cmbBodega.EditValue,
            ...
            DT1 = clsLnTrans_movimientos.Get_Reporte_Cant_Movimientos_By_Operador_And_Producto(dtpFechaDel.Value,
                                                                                               dtpFechaAl.Value,
                                                                                               IdProductoBodega,
                                                                                               cmbBodega.EditValue,
                                                                                               cmbPropietario.EditValue)
    ...
    Private Sub frmCambiosUbicacion_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub lblProducto_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lblProducto.LinkClicked
        ...
        Try
            ...
            grdCambiosUbic.DataSource = Nothing
    ...
    Private Sub Imprimir_Vista()
        ...
        Try
            ...
            printLink.Component = grdCambiosUbic
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Movimientos de Ubicación"
    ...
    Private Sub cmdExToExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdExToExcel.ItemClick
        Exportar_Grid_A_Excel(grdCambiosUbic, "ProgresoPicking.xlsx")
    End Sub
