...
Public Class frmResumenExistenciasTodos
    ...
    Private Sub SetDatataTable()
        ...
        DTs.Columns.Add("Clasificación", GetType(String))
    ...
    Private Sub Cargar()
        ...
        Try
            ...
            DT = clsLnStock.Get_All_Stock_Consolidado_DT_Report_Clasificacion(cmbBodega.EditValue, IIf(chkTodos.Checked, 0, cmbPropietario.EditValue))
