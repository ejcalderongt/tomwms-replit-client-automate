...
Public Class frmStockPorTipo
    ...
    Private Sub cargarDatos()
        ...
        Try
            ...
            DT = clsLnStock.Get_Inventario_Stock_Por_Tipo()
            ...
            If DT.Rows.Count > 0 Then
                ...
                GridView1.Columns("Tipo").GroupIndex = 0
                ...
                GridView1.Columns("fecha_ingreso").Caption = "Fecha_Ingreso"
