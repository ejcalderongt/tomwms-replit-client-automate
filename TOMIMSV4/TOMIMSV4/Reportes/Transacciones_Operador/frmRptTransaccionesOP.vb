...
Public Class frmRptTransaccionesOP
    ...
    Private Sub Cargar()
        ...
        Try
            ...
            dt = clsLnTarea_hh.Get_Lista_Tareas_Operador_By_IdBodega(cmbBodega.EditValue, dtpFechaDel.Value, dtpFechaAl.Value)
            ...
            If cmbBodega.Text <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    GridView.Columns("IdTarea").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
                    GridView.Columns("IdTarea").SummaryItem.DisplayFormat = "{0:0}"
                    GridView.Columns("IdTarea").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView.Columns("IdTarea").DisplayFormat.FormatString = "{0:0}"

                    GridView.Columns("Fecha").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
                    GridView.Columns("Fecha").DisplayFormat.FormatString = "d"
    ...
    Private Sub frmRptTransaccionesOP_Load(sender As Object, e As EventArgs) Handles Me.Load
