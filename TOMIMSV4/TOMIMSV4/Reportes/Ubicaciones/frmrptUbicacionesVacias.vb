...
Public Class frmrptUbicacionesVacias
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Detalle de ubicaciones vacías."
    ...
    Private Sub cmdExToExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdExToExcel.ItemClick
        Exportar_Grid_A_Excel(dgAuditoriaPicking, "UbicacionesVacías.xlsx")
    End Sub
    ...
    Private vNombreArchivoLayOutGrid As String = "GridUbicacionesVacias"
    ...
    Private Sub frmProgresoPicking_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        Try
            ...
            SplashScreenManager.Default.SetWaitFormDescription("Listando datos...")
    ...
    Private Sub dtpFechaDesde_ValueChanged(sender As Object, e As EventArgs)
        'Cargar_Datos()
    End Sub

    Private Sub dtpfechaHasta_ValueChanged(sender As Object, e As EventArgs)
        ' Cargar_Datos()
    End Sub
