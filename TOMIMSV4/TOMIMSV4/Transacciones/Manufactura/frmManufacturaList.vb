...
Public Class frmManufacturaList
    ...
    Public Property gBeManufactura As New clsBeTrans_manufactura_enc
    ...
    Private Sub Listar_Manufactura()

        Try

            Dim DT As New DataTable("Result")

            DT = clsLnTrans_manufactura_enc.Get_All_By_IdBodega(chkActivos.Checked,
                                                                dtpFechaDel.Value,
                                                                dtpFechaAl.Value,
                                                                AP.IdBodega)
            ...
            If GridView1.RowCount > 0 Then
                ...
                GridView1.Columns("IdTipoManufactura").Visible = False
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            SplashScreenManager.Default.SetWaitFormDescription("Nuevo Documento de Manufactura...")

            'Listar los pedidos que estén pickeados para asociarles una nueva tarea de manufactura.
            ...
            With frmManufactura
                .Modo = frmManufactura.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .InvokeListar_Manufactura = AddressOf Listar_Manufactura
    ...
    Public Sub Procesar_Registro()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                SplashScreenManager.ShowForm(Me, GetType(WaitForm), True, True, False)
                SplashScreenManager.Default.SetWaitFormCaption("Cargando Manufactura")

                Dim lSelectionIndex As Integer = GridView1.FocusedRowHandle
                gBeManufactura.IdManufacturaEnc = Dr.Item("Correlativo")
                clsLnTrans_manufactura_enc.Obtener(gBeManufactura)
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmManufactura
                        .Modo = frmManufactura.TipoTrans.Editar
                        .BeManufacturaEnc = gBeManufactura
                        .MdiParent = MdiParent
                        .InvokeListar_Manufactura = AddressOf Listar_Manufactura
    ...
    Private Sub frmManufactura_List_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
