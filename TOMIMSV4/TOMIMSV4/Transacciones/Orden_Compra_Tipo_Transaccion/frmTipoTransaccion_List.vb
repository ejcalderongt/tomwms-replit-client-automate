...
Public Class frmTipoTransaccion_List

    Public pObj As New clsBeTrans_re_tr
    ...
    Private Sub Listar_TipoTransaccion()
        ...
        Try
            ...
            d.Columns.Add("Código", GetType(String))
            d.Columns.Add("Descripción", GetType(String))
            d.Columns.Add("Funcionalidad", GetType(String))
            d.Columns.Add("Usa HandHeld", GetType(Boolean))

            Dim l As List(Of clsBeTrans_re_tr) = clsLnTrans_re_tr_Partial.GetAllFiltro(pConReferencia, pTipoTrans, pFiltro)

            For Each o As clsBeTrans_re_tr In l
                d.Rows.Add(o.IdTipoTransaccion, o.Descripcion, o.Funcionalidad, o.UsaHH)
            Next
    ...
    Private Sub Dgrid_DoubleClick(sender As Object, e As EventArgs) Handles Dgrid.DoubleClick
        Try
            If (GridView1.RowCount > 0) Then
                ...
                pObj.IdTipoTransaccion = Dr.Item("Código").ToString
                pObj = clsLnTrans_re_tr_Partial.GetSingle(pObj.IdTipoTransaccion)
    ...
    Private Sub PrintableComponentLink_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Try
            ...
            Dim reportHeader As String = vbNewLine & "Listado de Tipo Transacciones"
