...
Public Class frmPreIngreso_List
    ...
    Private Sub frmPreIngreso_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Pre_Ingresos()
    End Sub

    Private Sub Listar_Pre_Ingresos()

        Try

            Dim DT As New DataTable

            DT = clsLnTrans_re_enc.GetAll(chkActivos.Checked, dtpFechaDel.Value, dtpFechaAl.Value, clsBeTrans_re_enc.pTipoTrans.PICH000)
            ...
            If GridView1.Columns.Count > 0 Then
                Try
                    ...
                    GridView1.Columns("IdTipoTransaccion").Visible = False
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            SplashScreenManager.Default.SetWaitFormCaption("Cargando pre-ingreso")

            Cierra_Instancia_Previa(frmPreIngreso)

            With frmPreIngreso
                .Modo = frmPreIngreso.TipoTrans.Nuevo
                .MdiParent = MdiParent
                .Listar = AddressOf Listar_Pre_Ingresos
                .Show()
                .txtIdTipoTR.Text = clsBeTrans_re_enc.pTipoTrans.PICH000.ToString()
        ...
        Try
            ...
            If (GridView1.RowCount > 0) Then
                ...
                If Modo = pModo.Lista Then
                    ...
                    With frmPreIngreso
                        .Modo = frmPreIngreso.TipoTrans.Editar
                        .MdiParent = MdiParent
                        .gBeRecepcion = gBeRecepcion
                        .Listar = AddressOf Listar_Pre_Ingresos
