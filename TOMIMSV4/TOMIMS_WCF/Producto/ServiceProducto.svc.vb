...
''' <summary>
''' Class ServiceProducto. Provides all functionality to work with the principal table producto.
''' </summary>
Public Class ServiceProducto
    ...
    Public Sub Insert(ByVal BeProducto As clsBeProducto,
        ...
        Try
            ...
            clsLnProducto.Guardar(BeProducto, ListBeProductoParametro, ListBeProductoCodigosBarra, ListBeProductoPresentacion, ListBeProductosSustitutos, ListBeProductoRellenado, ListBePresentacionTarima, ListBeProductoBodega, ListBeConversionesPresentacion, Nothing)
    ...
    Public Function Exist_By_Codigo_Barra(ByVal CodigoBarra As String) As Boolean Implements IServiceProducto.Exist_By_Codigo_Barra
        ...
        Try
            Return clsLnProducto.Existe_Codigo_Barra(CodigoBarra)
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
    ...
    ''' <exception cref="FaultException"></exception>
    ''' <exception cref="System.Exception"></exception>
    Public Function Get_Rep_Stock_Minimo() As List(Of clsBeStock.Revision) Implements IServiceProducto.Get_Rep_Stock_Minimo

        Try
            Return clsLnProducto.GetRevision()
        Catch ex As FaultException
            Throw New FaultException(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex.Message))
        Catch ex1 As Exception
            Throw New Exception(String.Format("{0} {1}", MethodBase.GetCurrentMethod().Name, ex1.Message))
    ...
    Public Function Get_All_Presentaciones_By_IdProducto(pIdProducto As Integer) As List(Of clsBeProducto_Presentacion) Implements IServiceProducto.Get_All_Presentaciones_By_IdProducto
