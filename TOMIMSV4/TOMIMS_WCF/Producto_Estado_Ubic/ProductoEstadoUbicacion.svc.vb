...
Public Class ProductoEstadoUbicacion
    ...
    ''' <exception cref="FaultException"></exception>
    ''' <exception cref="System.Exception"></exception>
    Public Function Get_All_By_IdEstado(ByVal pIdEstado As Integer) As List(Of clsBeProducto_estado_ubic) Implements IProductoEstadoUbicacion.Get_All_Filtro
