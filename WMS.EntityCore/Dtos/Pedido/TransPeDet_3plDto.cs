...
namespace WMSWebAPI.Dtos.Pedido
{
    public class TransPeDet_3plDto
    {
        ...
        // JSON demo incluye Stock_Liberado
        public bool Stock_Liberado { get; set; } = false;
        ...
        public string? ProductoUnidadMedida { get; set; } = null;
        public string? ProductoEstado { get; set; } = null;
        public string? BodegaUbicacion { get; set; } = null;
