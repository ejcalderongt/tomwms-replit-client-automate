...
{
    public partial class VwPickingUbicByIdPedidoDet
    {
        ...
        public int? PdetIdPresentacion { get; set; }
        public int? IdUnidadMedidaBasica { get; set; }
        public int PdetIdProductoBodega { get; set; }
        ...
        public int? StockResIdStock { get; set; }
