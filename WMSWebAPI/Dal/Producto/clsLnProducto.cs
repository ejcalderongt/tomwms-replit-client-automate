...
public class clsLnProducto
{
    ...
    public static bool ExisteProducto(int IdProducto, SqlConnection pConnection, SqlTransaction pTransaction)
    {
        try
        {
    ...
    public static int InsertarOActualizar(IConfiguration config, clsBeProducto entity, SqlConnection? conn = null, SqlTransaction? tx = null)
    {
        ...
        try
        {
            ...
            bool existe = ExisteProducto(entity.IdProducto, connection, isExternalTx ? tx! : localTx!);
