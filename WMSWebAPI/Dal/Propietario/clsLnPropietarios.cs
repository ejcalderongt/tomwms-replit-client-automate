...
public class clsLnPropietarios
{
    ...
    public static int Insertar(IConfiguration config, clsBePropietarios oBePropietarios, SqlConnection? pConection = null, SqlTransaction? pTransaction = null)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@nombre_comercial", oBePropietarios.Nombre_Comercial));
            cmd.Parameters.Add(new SqlParameter("@imagen", oBePropietarios.Imagen));
            ...
            cmd.Parameters.Add(new SqlParameter("@codigo_acceso", oBePropietarios.codigo_acceso));
            cmd.Parameters.Add(new SqlParameter("@clave_acceso", oBePropietarios.clave_acceso));
            cmd.Parameters.Add(new SqlParameter("@IdBodegaAreaSAP", oBePropietarios.IdBodegaAreaSAP));
    ...
    public static void Bind(SqlCommand cmd, clsBePropietarios o)
    {
        ...
        cmd.Parameters.AddWithValue("@codigo", string.IsNullOrEmpty(o.codigo) ? DBNull.Value : o.codigo); // fix aquí: antes era o.color
