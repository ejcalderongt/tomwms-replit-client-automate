...
public class clsLnTrans_re_oc
{
    ...
    public static int Insertar(IConfiguration config, clsBeTrans_re_oc oBeTrans_re_oc, SqlConnection? pConection = null, SqlTransaction? pTransaction = null)
    {
    ...
    public static int Actualizar(IConfiguration config, clsBeTrans_re_oc oBeTrans_re_oc, SqlConnection? pConection = null, SqlTransaction? pTransaction = null)
    {
    ...
    public static void Bind(SqlCommand cmd, clsBeTrans_re_oc oBeTrans_re_oc)
    {
        ...
        cmd.Parameters.Add(new SqlParameter("@no_docto", string.IsNullOrEmpty(oBeTrans_re_oc.No_docto) ? DBNull.Value : oBeTrans_re_oc.No_docto));
        cmd.Parameters.Add(new SqlParameter("@hora_ini_hh", oBeTrans_re_oc.Hora_ini_hh == default ? DBNull.Value : oBeTrans_re_oc.Hora_ini_hh));
        cmd.Parameters.Add(new SqlParameter("@hora_fin_hh", oBeTrans_re_oc.Hora_fin_hh == default ? DBNull.Value : oBeTrans_re_oc.Hora_fin_hh));
        cmd.Parameters.Add(new SqlParameter("@user_agr", string.IsNullOrEmpty(oBeTrans_re_oc.User_agr) ? DBNull.Value : oBeTrans_re_oc.User_agr));
        cmd.Parameters.Add(new SqlParameter("@fec_agr", oBeTrans_re_oc.Fec_agr == default ? DBNull.Value : oBeTrans_re_oc.Fec_agr));
        cmd.Parameters.Add(new SqlParameter("@firma_operador", oBeTrans_re_oc.Firma_operador == null || oBeTrans_re_oc.Firma_operador.Length == 0 ? DBNull.Value : oBeTrans_re_oc.Firma_operador));
    }
    public static void InsertarOActualizar(IConfiguration config, List<clsBeTrans_re_oc> entities, SqlConnection? conn = null, SqlTransaction? tx = null)
    {
        ...
        try
        {
            ...
            {
                bool existe = Existe(entity.IdRecepcionOc, connection, isExternalTx ? tx! : localTx!);
    ...
    public static bool Existe(int idRecepcionOc, SqlConnection conn, SqlTransaction tx)
    {
        try
        {
            const string query = "SELECT COUNT(1) FROM trans_re_oc WHERE idrecepcionoc = @idrecepcionoc";
