    ...
    public void ProcesarProductoDesdeDto(ProductoTransDto dto, SqlConnection conn, SqlTransaction tx)
    {
        try
        {
            if (dto.Propietario != null)
                clsLnPropietarios.InsertOrUpdate(_configuration, _mapper.Map<clsBePropietarios>(dto.Propietario), conn, tx);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            if (dto.PropietarioBodega != null)
                clsLnPropietario_bodega.InsertOrUpdate(_configuration, _mapper.Map<clsBePropietario_bodega>(dto.Propietario), conn, tx);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            if (producto != null)
                clsLnProducto.InsertarOActualizar(_configuration, producto, conn, tx);
        }
        catch (Exception ex)
        {
