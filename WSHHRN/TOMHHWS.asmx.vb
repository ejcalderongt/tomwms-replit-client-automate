...
New JsonSerializerSettings With {
   ...
   .Mensaje = ex.Message
        ...
        <WebMethod(), SoapHeader("mArch")>
        Public Function Cargar_Stock_RFID_Paginado(pPagina As Integer, pTamanoPagina As Integer, pTextoBusqueda As String, pCriterioBusqueda As String) As List(Of clsBeI_nav_barras_rfid_enc)

            Cargar_Stock_RFID_Paginado = New List(Of clsBeI_nav_barras_rfid_enc)

            Try

                Cargar_Stock_RFID_Paginado = clsLnI_nav_barras_rfid_enc.Get_Stock_WS_Paginado(pPagina, pTamanoPagina, pTextoBusqueda, pCriterioBusqueda)
