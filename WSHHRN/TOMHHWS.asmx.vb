...
Public Class TOMHHWS
    ...
    <WebMethod(), SoapHeader("mArch")>
    Public Sub Get_Banderas_Recepcion(ByVal pIdRecepcionEnc As Integer, ByRef pFinalizada As Boolean, pAnulada As Boolean)
    ...
    ''' <summary>
    ''' #EJC20220419: Obtener el IdUbicacionRecepcion por defecto de la bodega.
    ''' </summary>
    ...
    '#AT 20220208 Copia de Inventario_Ciclico_Actualiza_Conteo, porque se hicieron cambios en la funcionalidad
    '<WebMethod(), SoapHeader("mArch")>
    'Public Function Inventario_Ciclico_Actualiza_Conteo_Andr(ByVal pitem As clsBeTrans_inv_ciclico,
    '                                                         ByVal pReconteo As Integer,
    '                                                         ByRef Resultado As String) As Integer

    '    Inventario_Ciclico_Actualiza_Conteo_Andr = 0
    ...
    '        Dim thread As New Thread(
    '              Sub()
    '                  clsLnTrans_inv_ciclico.Actualiza_Conteo_Ciclico_HH(pitem, pReconteo, Res)
    '              End Sub
    '            )
    ...
    Public Function Actualizar_PickingEnc_Procesado_Andr(ByVal pIdPickingEnc As Integer,
        ...
        Try
            ...
            Return clsLnTrans_picking_enc.Actualizar_PickingEnc_Procesado_Andr(pIdPickingEnc,
    ...
    Public Function Actualizar_PickingEnc_Verificado(ByRef oBeTrans_picking_enc As clsBeTrans_picking_enc) As Integer
        ...
        Try
            ...
            Return clsLnTrans_picking_enc.Actualizar_PickingEnc_Verificado(oBeTrans_picking_enc)
    ...
    <WebMethod(), SoapHeader("mArch")>
    Public Function Get_Detalle_By_IdPedidoEnc(ByVal pIdPedidoEnc As Integer) As List(Of clsBeDetallePedidoAVerificar)

        Get_Detalle_By_IdPedidoEnc = Nothing

        Try

            Return clsLnTrans_pe_det.Get_Detalle_By_IdPedidoEnc(pIdPedidoEnc)
    ...
    Public Function Set_Estado_Pedido_Verificado(ByRef oBeTrans_pe_enc As clsBeTrans_pe_enc) As Integer
        ...
        Try
            ...
            Return clsLnTrans_pe_enc.Actualizar_Estado_Verificado(oBeTrans_pe_enc)
