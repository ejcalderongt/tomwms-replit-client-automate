...
tags: [atlas, ficha-cliente, cliente/killios, F5]
...
|---|---|
| **Cliente** | `killios` |
| **Database** | `TOMWMS_KILLIOS_PRD` en EC2 `52.41.114.122:1437` |
| **Environment** | PRD |
| **Rubro** | Gastronómico |
...
| **BUG-001 severidad** | CRÍTICA — snapshot histórico (3 meses) |

> Snapshot histórico 2025-06 → 2025-08 (BD vieja). La activa es KILLIOS_PRD_2026.
...
| `Enviado_A_ERP = 1` | 103 (12%) |
| `Enviado_A_ERP = 0/NULL` (pendientes) | **722** (88%) |
...
- **Total**: 24,193 filas
- **Pendientes (enviado=0)**: 3 (0.0%)

### Logs disponibles

- Tablas pobladas: `log_error_wms`
- Total filas log_error_wms_*: 66,339

📂 **Snapshot completo**: [`data-deep-dive/killios/snapshot-2026-05-05.md`](../data-deep-dive/killios/snapshot-2026-05-05.md)
