...
tags: [atlas, ficha-cliente, cliente/mercopan, F5]
...
|---|---|
| **Cliente** | `mercopan` |
| **Database** | `IMS4MB_MERCOPAN_PRD` en EC2 `52.41.114.122:1437` |
| **Environment** | PRD |
| **Rubro** | Consumo masivo (aceites, detergentes) |
| **ERP destino** | NAV (probable) |
| **Rama productiva** | `dev_2023_estable` |
| **Modelo configuración** | PRODUCT-CENTRIC |
| **Fingerprint** | `(pendiente fingerprint formal)` |
| **BUG-001 severidad** | CRÍTICA — el más grave histórico (574k UM en 29 meses) |

> El más grave en volumen absoluto histórico. 19,607 daños / 574k UM en 29 meses. Felix Mariscal + Abel Castillo = 88%. Estado actual UNKNOWN (backup termina jul-2024). 3,094 AJCANTN históricos = máxima compensación manual del bug.
...
| `Enviado_A_ERP = 1` | 171 (9%) |
| `Enviado_A_ERP = 0/NULL` (pendientes) | **1,706** (91%) |

### Bodegas configuradas (1)

| IdBodega | código | nombre | activo |
|---|---|---|---|
| 14 | 04 | BODEGA MERCOPAN | ✓ |

### Outbox `i_nav_transacciones_out`

- **Total**: 147,137 filas
- **Pendientes (enviado=0)**: 14,762 (10.0%)

### Logs disponibles

- Tablas pobladas: `log_error_wms`
- Total filas log_error_wms_*: 70,656

📂 **Snapshot completo**: [`data-deep-dive/mercopan/snapshot-2026-05-05.md`](../data-deep-dive/mercopan/snapshot-2026-05-05.md)
...
- 📄 Ficha detallada: [`clients/mercopan.md`](../clients/mercopan.md)
