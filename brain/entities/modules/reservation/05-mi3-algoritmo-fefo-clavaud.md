...
El motor nuevo concentra el cálculo de fechas mínimas FEFO en una pasada, exponiendo 4 valores en `ReservationContext`:
...
|----------------------------------------|--------------------------------------------------|--------------------------------------------------|
| Cálculo fecha mínima                   | 3+ llamadas a BD (`Get_Fecha_Vence_Minima_*`)    | 1 pasada en `DateCalculationStep` (in-memory)    |
