...
version: V0
status: obsoleto
superseded_by: cambio-ubicacion-idealsa-V1.md
authored_by: agente-brain
authored_at: 2026-04-28T20:30:00-03:00
deprecated_at: 2026-04-28T21:00:00-03:00
deprecation_reasons:
  - "stack incorrecto: V0 dice .NET 8, el correcto es .NET 10 (.NET 8 esta reservado para el bridge brain<->WMS)"
  - "flujo HH incorrecto: V0 asume HH consume REST directo, pero la HH usa el WebService existente"
---

> **AVISO**: este documento esta OBSOLETO. La version vigente es `cambio-ubicacion-idealsa-V1.md`. Se conserva para trazabilidad - no usar como fuente.
