...
- q1-cantidades-fraccional-vs-entera.csv (CSV de salida)
- q2-precision-decimal.csv (CSV de salida)
- q3-unidades-fraccionables.csv (CSV de salida)
- q1-cantidades-fraccional-vs-entera.json (JSON crudo: ok/rowCount/rows/ms)
- q2-precision-decimal.json (JSON crudo: ok/rowCount/rows/ms)
- q3-unidades-fraccionables.json (JSON crudo: ok/rowCount/rows/ms)
