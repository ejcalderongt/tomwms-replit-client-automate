---
id: db-brain-sp-sp-whoisactive
type: db-sp
title: dbo.sp_WhoIsActive
schema: dbo
name: sp_WhoIsActive
kind: sp
...
|---:|---|---|:-:|
| 1 | `@filter` | `sysname` |  |
| 2 | `@filter_type` | `varchar(10)` |  |
| 3 | `@not_filter` | `sysname` |  |
| 4 | `@not_filter_type` | `varchar(10)` |  |
| 5 | `@show_own_spid` | `bit` |  |
| 6 | `@show_system_spids` | `bit` |  |
| 7 | `@show_sleeping_spids` | `tinyint` |  |
| 8 | `@get_full_inner_text` | `bit` |  |
| 9 | `@get_plans` | `tinyint` |  |
| 10 | `@get_outer_command` | `bit` |  |
| 11 | `@get_transaction_info` | `bit` |  |
| 12 | `@get_task_info` | `tinyint` |  |
| 13 | `@get_locks` | `bit` |  |
| 14 | `@get_avg_time` | `bit` |  |
| 15 | `@get_additional_info` | `bit` |  |
| 16 | `@find_block_leaders` | `bit` |  |
| 17 | `@delta_interval` | `tinyint` |  |
| 18 | `@output_column_list` | `varchar(8000)` |  |
| 19 | `@sort_order` | `varchar(500)` |  |
| 20 | `@format_output` | `tinyint` |  |
| 21 | `@destination_table` | `varchar(4000)` |  |
| 22 | `@return_schema` | `bit` |  |
| 23 | `@schema` | `varchar(max)` | ✓ |
| 24 | `@help` | `bit` |  |
