---
id: db-brain-table-producto-parametro-a
type: db-table
title: dbo.producto_parametro_a
schema: dbo
name: producto_parametro_a
kind: table
rows: 0
...
|---|---|---|
| `PK_producto_parametro_a` | CLUSTERED · **PK** | IdProductoParametroA |
