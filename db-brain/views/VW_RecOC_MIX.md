---
id: db-brain-view-vw-recoc-mix
type: db-view
title: dbo.VW_RecOC_MIX
schema: dbo
name: VW_RecOC_MIX
kind: view
...
| 22 | `IdRecepcionOc` | `int` | ✓ |  |
| 23 | `No_Documento` | `nvarchar(50)` | ✓ |  |
| 24 | `Id_Proveedor` | `int` | ✓ |  |
| 25 | `Proveedor` | `nvarchar(50)` | ✓ |  |
...
SELECT     TOP (100) PERCENT dbo.trans_re_enc.IdRecepcionEnc, dbo.trans_re_det.IdRecepcionDet, dbo.trans_re_enc.IdPropietarioBodega, 
                      ...
                      dbo.unidad_medida.Nombre AS Unidad_Medida, dbo.trans_oc_enc.IdOrdenCompraEnc, dbo.trans_re_oc.IdRecepcionOc, dbo.trans_re_oc.no_docto AS No_Documento, 
                      dbo.proveedor_bodega.IdProveedor AS Id_Proveedor, dbo.proveedor.nombre AS Proveedor
FROM         dbo.trans_re_oc INNER JOIN
                      ...
                      dbo.trans_oc_enc.IdPropietarioBodega = dbo.trans_re_enc.IdPropietarioBodega LEFT OUTER JOIN
