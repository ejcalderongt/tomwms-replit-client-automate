...
dbo.trans_manufactura_tipo mt ON mt.idtipomanufactura = me.IdTipoManufactura LEFT OUTER JOIN
dbo.producto_talla_color ptc ON pubic.IdProductoTallaColor = ptc.IdProductoTallaColor LEFT OUTER JOIN
dbo.talla t ON ptc.IdTalla = t.IdTalla LEFT OUTER JOIN
dbo.color c ON ptc.IdColor = c.IdColor
...
P.codigo, ped.ndias,pubic.dañado_verificacion, pubic.lic_plate, pubic.IdPresentacion, dbo.producto_presentacion.nombre, 
pubic.IdProductoBodega, pubic.IdProductoEstado, pubic.IdBodega, pc.nombre, dbo.bodega_ubicacion.IdArea,
P.IdTipoManufactura, mt.nombre,pubic.IdProductoTallaColor, c.Codigo, t.Codigo, c.Nombre, t.Nombre, ptc.CodigoSKU
